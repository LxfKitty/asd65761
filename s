...
// ===== CFnew UI layer: upstream runtime stays intact; this layer only controls presentation =====
const __CF_UI_VERSION = 'cfnew-ios-glass-edt-v2';
const __CF_UI_FEATURES = Object.freeze({ notifications: false, logs: false });
...
:root{--cf-bg:#edf3fa;--cf-bg2:#e4ecf7;--cf-panel:rgba(255,255,255,.64);--cf-panel2:rgba(255,255,255,.55);--cf-control:rgba(255,255,255,.74);--cf-text:#172333;--cf-muted:#65758a;--cf-faint:#8d99aa;--cf-border:rgba(63,86,117,.13);--cf-border2:rgba(63,86,117,.23);--cf-accent:#4f7cff;--cf-accent2:#7597ff;--cf-accent-soft:rgba(79,124,255,.12);--cf-success:#278d68;--cf-danger:#c75163;--cf-shadow:0 30px 80px rgba(58,76,102,.14),0 8px 24px rgba(58,76,102,.07);--cf-inner:inset 0 1px 0 rgba(255,255,255,.82);--cf-radius-xl:26px;--cf-radius-lg:20px;--cf-radius-md:14px}
html[data-cfnew-theme="dark"]{--cf-bg:#0f1721;--cf-bg2:#172332;--cf-panel:rgba(27,39,53,.64);--cf-panel2:rgba(31,45,60,.62);--cf-control:rgba(42,57,73,.7);--cf-text:#edf3fb;--cf-muted:#a9b5c4;--cf-faint:#7f8c9e;--cf-border:rgba(228,238,250,.12);--cf-border2:rgba(228,238,250,.2);--cf-accent:#82a5ff;--cf-accent2:#a0b9ff;--cf-accent-soft:rgba(130,165,255,.15);--cf-success:#6bc19b;--cf-danger:#e6818d;--cf-shadow:0 34px 90px rgba(0,0,0,.35),0 8px 24px rgba(0,0,0,.22);--cf-inner:inset 0 1px 0 rgba(255,255,255,.08)}
html,body{height:auto!important;min-height:100%!important;overflow-x:hidden!important;overflow-y:auto!important;overscroll-behavior-y:auto!important;background:var(--cf-bg)!important;color:var(--cf-text)!important;scroll-behavior:smooth!important}
body{font-family:-apple-system,BlinkMacSystemFont,"SF Pro Display","SF Pro Text","Segoe UI","PingFang SC","Microsoft YaHei",Arial,sans-serif!important;background:radial-gradient(circle at 11% 10%,rgba(112,150,235,.18),transparent 34%),radial-gradient(circle at 86% 82%,rgba(127,111,208,.12),transparent 38%),linear-gradient(145deg,var(--cf-bg),var(--cf-bg2))!important;color:var(--cf-text)!important;text-shadow:none!important;-webkit-font-smoothing:antialiased!important}
body:before,body:after{animation:none!important}.page-wrapper{width:100%!important;max-width:none!important;height:auto!important;min-height:100vh!important;padding:72px 18px 110px!important;box-sizing:border-box!important;overflow:visible!important;display:flex!important;align-items:flex-start!important;justify-content:center!important}.card-container{position:relative!important;width:min(100%,1120px)!important;max-width:1120px!important;height:auto!important;min-height:0!important;margin:0 auto!important;padding:28px!important;border:1px solid var(--cf-border)!important;border-radius:var(--cf-radius-xl)!important;background:linear-gradient(145deg,rgba(255,255,255,.18),transparent 52%),var(--cf-panel)!important;box-shadow:var(--cf-shadow),var(--cf-inner)!important;backdrop-filter:blur(32px) saturate(145%)!important;-webkit-backdrop-filter:blur(32px) saturate(145%)!important;color:var(--cf-text)!important;overflow:visible!important}.card-container:before,.card-container:after{display:none!important}
.header,.page-header{position:relative!important;padding:4px 2px 22px!important;margin:0 0 18px!important;border-top:0!important;border-bottom:1px solid var(--cf-border)!important;background:transparent!important;box-shadow:none!important}.header:before,.header:after,.page-header:before,.page-header:after{display:none!important;content:none!important}.header h1,.header-title h1,#pageTitle,.page-title{margin:0!important;color:var(--cf-text)!important;background:none!important;-webkit-text-fill-color:currentColor!important;text-shadow:none!important;font-weight:780!important;letter-spacing:-.025em!important}.header p,.header-subtitle,.page-subtitle,.subtitle{color:var(--cf-muted)!important;text-shadow:none!important}.page-icon{border-radius:16px!important;background:linear-gradient(145deg,var(--cf-accent),var(--cf-accent2))!important;box-shadow:0 12px 28px rgba(79,124,255,.22)!important;color:#fff!important}
.module,.network-card,.latency-card,.cf-stats-card,.cf-info-box,.status-card,.config-card{border:1px solid var(--cf-border)!important;border-radius:var(--cf-radius-lg)!important;background:linear-gradient(145deg,rgba(255,255,255,.19),transparent 52%),var(--cf-panel2)!important;box-shadow:0 12px 34px rgba(42,59,81,.065),var(--cf-inner)!important;color:var(--cf-text)!important;backdrop-filter:blur(22px) saturate(135%)!important;-webkit-backdrop-filter:blur(22px) saturate(135%)!important;overflow:hidden!important}.module{margin:0 0 16px!important;padding:22px!important}.module:hover,.network-card:hover,.latency-card:hover{border-color:var(--cf-border2)!important;transform:none!important}.module-title,.network-card-title,.card-title,.section-title{display:flex!important;align-items:center!important;gap:10px!important;color:var(--cf-text)!important;border-color:var(--cf-border)!important;text-shadow:none!important;font-weight:760!important}.module-title:before,.module-title:after{box-shadow:none!important}.form-group label,.form-label,label{color:var(--cf-text)!important;text-shadow:none!important}.hint,.description,.form-hint,.help-text,small,.footer-hint{color:var(--cf-muted)!important}
input,select,textarea,.input-wrapper input,.input-wrapper select,.input-wrapper textarea{box-sizing:border-box!important;background:var(--cf-control)!important;color:var(--cf-text)!important;border:1px solid var(--cf-border)!important;border-radius:13px!important;box-shadow:var(--cf-inner)!important;text-shadow:none!important;outline:none!important;transition:border-color .2s,box-shadow .2s,background .2s!important}input:focus,select:focus,textarea:focus{border-color:var(--cf-accent)!important;box-shadow:0 0 0 3px var(--cf-accent-soft),var(--cf-inner)!important}input::placeholder,textarea::placeholder{color:var(--cf-faint)!important}select option{background:var(--cf-panel2)!important;color:var(--cf-text)!important}.input-wrapper:before,.input-wrapper:after{display:none!important}
button,.btn,.button{font-family:inherit!important;text-shadow:none!important;box-shadow:none!important;clip-path:none!important}.btn,button[class*="btn"],.button{border:1px solid var(--cf-border)!important;border-radius:12px!important;background:var(--cf-control)!important;color:var(--cf-text)!important;transition:transform .16s,border-color .2s,background .2s!important;backdrop-filter:blur(16px)!important;-webkit-backdrop-filter:blur(16px)!important}.btn:hover,button[class*="btn"]:hover,.button:hover{border-color:var(--cf-border2)!important;transform:translateY(-1px)!important}.btn-primary,.primary-btn,.save-btn,.login-btn,.btn-success{background:linear-gradient(135deg,var(--cf-accent),var(--cf-accent2))!important;border-color:transparent!important;color:#fff!important;box-shadow:0 10px 24px rgba(79,124,255,.22)!important}.btn-danger,.danger-btn{background:rgba(199,84,99,.1)!important;border-color:rgba(199,84,99,.22)!important;color:var(--cf-danger)!important}.btn-secondary,.secondary-btn{background:var(--cf-control)!important;color:var(--cf-text)!important}.status-success,.success,.online{color:var(--cf-success)!important}.status-error,.error,.danger,.offline{color:var(--cf-danger)!important}.badge,.tag,.status-badge{border-color:var(--cf-border)!important;background:var(--cf-accent-soft)!important;color:var(--cf-accent)!important;box-shadow:none!important}
.modal-overlay,.overlay{background:rgba(15,23,33,.36)!important;backdrop-filter:blur(12px)!important;-webkit-backdrop-filter:blur(12px)!important}.modal,.modal-content,.dialog{border:1px solid var(--cf-border)!important;border-radius:22px!important;background:var(--cf-panel)!important;color:var(--cf-text)!important;box-shadow:var(--cf-shadow),var(--cf-inner)!important;backdrop-filter:blur(28px) saturate(145%)!important;-webkit-backdrop-filter:blur(28px) saturate(145%)!important}.tabs,.tab-list,.header-buttons,.button-group,.module-footer{gap:8px!important}.tab,.tab-button{border-radius:11px!important;color:var(--cf-muted)!important}.tab.active,.tab-button.active{background:var(--cf-accent-soft)!important;color:var(--cf-accent)!important}.subscription-link-wrapper,.link-wrapper,.code-block,pre{border:1px solid var(--cf-border)!important;border-radius:13px!important;background:var(--cf-control)!important;color:var(--cf-text)!important}.qr-code,.qrcode{border:1px solid var(--cf-border)!important;border-radius:15px!important;background:#fff!important;padding:8px!important}
.footer,.social-links{display:none!important}.footer-hint{opacity:.72!important}#background-iframe,#blur-overlay,.background-iframe,.background-video,.particles,.matrix-bg,.matrix-code-rain{display:none!important}
.cfnew-brand{position:fixed;top:16px;left:18px;z-index:2147483000;display:flex;align-items:center;gap:8px;padding:8px 12px;border:1px solid var(--cf-border);border-radius:14px;background:var(--cf-panel);box-shadow:0 12px 34px rgba(28,39,53,.09),var(--cf-inner);backdrop-filter:blur(22px) saturate(140%);-webkit-backdrop-filter:blur(22px) saturate(140%);color:var(--cf-text);font-size:12px;font-weight:760;letter-spacing:.02em}.cfnew-brand i{width:8px;height:8px;border-radius:50%;background:var(--cf-accent);box-shadow:0 0 0 4px var(--cf-accent-soft)}
.cfnew-theme-switcher{position:fixed;top:16px;right:18px;z-index:2147483000;display:flex;align-items:center;gap:3px;padding:6px;border:1px solid var(--cf-border);border-radius:14px;background:var(--cf-panel);box-shadow:0 12px 34px rgba(28,39,53,.09),var(--cf-inner);backdrop-filter:blur(22px) saturate(140%);-webkit-backdrop-filter:blur(22px) saturate(140%)}.cfnew-theme-switcher span{color:var(--cf-muted);font-size:11px;font-weight:660;padding:0 5px}.cfnew-theme-switcher button{min-width:0!important;padding:7px 9px!important;border:0!important;border-radius:9px!important;background:transparent!important;color:var(--cf-muted)!important;font-size:12px!important;font-weight:660!important;cursor:pointer!important}.cfnew-theme-switcher button:hover{background:var(--cf-accent-soft)!important;color:var(--cf-text)!important;transform:none!important}.cfnew-theme-switcher button.is-active{background:var(--cf-control)!important;color:var(--cf-accent)!important;box-shadow:0 1px 5px rgba(30,45,65,.1)!important}
.cfnew-icon{display:inline-flex!important;align-items:center!important;justify-content:center!important;flex:0 0 auto!important;width:18px!important;height:18px!important;color:var(--cf-accent)!important}.cfnew-icon svg{display:block!important;width:100%!important;height:100%!important;fill:none!important;stroke:currentColor!important;stroke-width:1.8!important;stroke-linecap:round!important;stroke-linejoin:round!important}.cfnew-button-icon{width:16px!important;height:16px!important;margin-right:6px!important;vertical-align:-3px!important}.cfnew-close-icon{margin:0!important;width:16px!important;height:16px!important}
#cfnewActionDock{position:fixed;right:24px;bottom:24px;z-index:2147483100;display:flex;align-items:center;gap:9px;padding:8px;border:1px solid var(--cf-border);border-radius:18px;background:var(--cf-panel);box-shadow:0 18px 48px rgba(32,48,70,.15),var(--cf-inner);backdrop-filter:blur(26px) saturate(150%);-webkit-backdrop-filter:blur(26px) saturate(150%)}#cfnewActionDock button{display:inline-flex!important;align-items:center!important;justify-content:center!important;width:44px!important;height:44px!important;min-width:44px!important;padding:0!important;border-radius:13px!important;cursor:pointer!important;background:var(--cf-control)!important;border:1px solid var(--cf-border)!important;color:var(--cf-text)!important}#cfnewActionDock button:hover{transform:translateY(-1px)!important;border-color:var(--cf-border2)!important}#cfnewActionDock .cfnew-dock-save{background:linear-gradient(135deg,var(--cf-accent),var(--cf-accent2))!important;color:#fff!important;border-color:transparent!important;box-shadow:0 9px 22px rgba(79,124,255,.24)!important}#cfnewActionDock .cfnew-icon{width:20px!important;height:20px!important;color:inherit!important}
html[data-cfnew-page="simple"] .card-container{width:min(100%,520px)!important;max-width:520px!important;margin-top:max(4vh,20px)!important;padding:30px!important}html[data-cfnew-page="simple"] .page-wrapper{align-items:center!important}
@media(max-width:760px){.page-wrapper{padding:68px 10px 100px!important}.card-container{padding:16px!important;border-radius:20px!important}.module{padding:16px!important}.cfnew-brand{left:10px;top:10px}.cfnew-theme-switcher{right:10px;top:10px}.cfnew-theme-switcher span{display:none}.cfnew-theme-switcher button{padding:7px!important;font-size:11px!important}#cfnewActionDock{right:12px;bottom:12px;padding:7px;border-radius:16px}#cfnewActionDock button{width:42px!important;height:42px!important;min-width:42px!important}}
</style>`;
const __CF_UI_RUNTIME = `<script id="cfnew-ui-runtime">(function(){
var K='cfnew-theme-mode',Q=window.matchMedia?window.matchMedia('(prefers-color-scheme: dark)'):null;
var ICONS={
network:'<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"></circle><path d="M3 12h18M12 3a15 15 0 0 1 0 18M12 3a15 15 0 0 0 0 18"></path></svg>',
link:'<svg viewBox="0 0 24 24"><path d="M10 13a5 5 0 0 0 7.1.1l2-2a5 5 0 0 0-7.1-7.1l-1.1 1.1"></path><path d="M14 11a5 5 0 0 0-7.1-.1l-2 2A5 5 0 0 0 12 20l1.1-1.1"></path></svg>',
zap:'<svg viewBox="0 0 24 24"><path d="M13 2 4.5 13H11l-1 9 8.5-11H12l1-9Z"></path></svg>',
settings:'<svg viewBox="0 0 24 24"><path d="M4 6h10M18 6h2M4 12h2M10 12h10M4 18h6M14 18h6"></path><circle cx="16" cy="6" r="2"></circle><circle cx="8" cy="12" r="2"></circle><circle cx="12" cy="18" r="2"></circle></svg>',
shield:'<svg viewBox="0 0 24 24"><path d="M12 3 5 6v5c0 4.6 2.8 8.1 7 10 4.2-1.9 7-5.4 7-10V6l-7-3Z"></path><path d="m9 12 2 2 4-4"></path></svg>',
cloud:'<svg viewBox="0 0 24 24"><path d="M7 18h10a4 4 0 0 0 .7-7.9A6 6 0 0 0 6.3 9 4.5 4.5 0 0 0 7 18Z"></path></svg>',
refresh:'<svg viewBox="0 0 24 24"><path d="M20 6v5h-5"></path><path d="M4 18v-5h5"></path><path d="M6.1 9A7 7 0 0 1 18 6l2 5M4 13l2 5a7 7 0 0 0 11.9-3"></path></svg>',
...
qr:'<svg viewBox="0 0 24 24"><path d="M4 4h6v6H4zM14 4h6v6h-6zM4 14h6v6H4zM15 14h1M19 14h1M14 18h2M18 17h2M18 20h2M14 20h1"></path></svg>',
...
logout:'<svg viewBox="0 0 24 24"><path d="M10 5H5v14h5M14 8l4 4-4 4M8 12h10"></path></svg>',
reset:'<svg viewBox="0 0 24 24"><path d="M4 4v6h6"></path><path d="M5.5 16a8 8 0 1 0 .7-9.2L4 10"></path></svg>',
help:'<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"></circle><path d="M9.8 9a2.5 2.5 0 1 1 3.5 2.3c-.8.4-1.3 1-1.3 1.7M12 17h.01"></path></svg>',
...
external:'<svg viewBox="0 0 24 24"><path d="M14 5h5v5M19 5l-8 8"></path><path d="M18 13v6H5V6h6"></path></svg>'};
...
function icon(name,extra){return '<span class="cfnew-icon '+(extra||'')+'" aria-hidden="true">'+(ICONS[name]||ICONS.info)+'</span>'}
function clean(s){return String(s||'').replace(/[\\uFE0E\\uFE0F\\u200D]/g,'').replace(/\\p{Extended_Pictographic}/gu,'').replace(/[✦⌘⌁↻↗⌫⌄]/g,'').replace(/\\s+/g,' ').trim()}
function stripText(root){var walker=document.createTreeWalker(root,NodeFilter.SHOW_TEXT);var list=[];while(walker.nextNode())list.push(walker.currentNode);list.forEach(function(n){if(n.parentElement&&n.parentElement.closest('script,style,textarea,pre,code'))return;var v=clean(n.nodeValue);if(v!==n.nodeValue.trim())n.nodeValue=(/^\\s/.test(n.nodeValue)?' ':'')+v+(/\\s$/.test(n.nodeValue)?' ':'')})}
function pickIcon(text){text=clean(text);if(/当前网络|网络信息|地区|目标地区/.test(text))return'network';if(/获取节点|节点链接|订阅接口|链式|链接/.test(text))return'link';if(/优选/.test(text))return'zap';if(/详细配置|参数配置|路径模板|配置/.test(text))return'settings';if(/ECH|证书|加密/.test(text))return'shield';if(/Cloudflare|Workers|Pages|CDN/.test(text))return'cloud';if(/订阅转换|刷新|更新/.test(text))return'refresh';if(/通知|Telegram/.test(text))return'bell';if(/日志/.test(text))return'file';if(/二维码/.test(text))return'qr';if(/复制/.test(text))return'copy';if(/保存|确定/.test(text))return'save';if(/退出/.test(text))return'logout';if(/重置|清除/.test(text))return'reset';if(/为什么|帮助|小白|什么是|如何/.test(text))return'help';if(/警告|注意|提示|重要/.test(text))return'warning';if(/关闭|取消/.test(text))return'close';if(/前往|更多|GitHub/.test(text))return'external';return'info'}
function decorate(root){stripText(root);var nodes=[];if(root.matches&&root.matches('button,.btn,.button,.module-title,.network-card-title,.card-title,.section-title,h1,h2,h3,h4'))nodes.push(root);if(root.querySelectorAll)nodes=nodes.concat(Array.from(root.querySelectorAll('button,.btn,.button,.module-title,.network-card-title,.card-title,.section-title,h1,h2,h3,h4')));nodes.forEach(function(el){if(el.closest('#cfnewActionDock,#cfnewThemeSwitcher'))return;var t=clean(el.textContent);if(/edgetunnel 设置页面/i.test(t)){Array.from(el.childNodes).forEach(function(n){if(n.nodeType===3&&/edgetunnel 设置页面/i.test(n.nodeValue))n.nodeValue=n.nodeValue.replace(/edgetunnel 设置页面/ig,'CFnew 设置中心')});t=clean(el.textContent)}if(!t)return;if((t==='×'||t==='x')&&!el.querySelector('.cfnew-icon')){el.textContent='';el.insertAdjacentHTML('afterbegin',icon('close','cfnew-close-icon'));el.setAttribute('aria-label','关闭');return}if(!el.querySelector(':scope > .cfnew-icon'))el.insertAdjacentHTML('afterbegin',icon(pickIcon(t),el.matches('button,.btn,.button')?'cfnew-button-icon':''))})}
function cardForHeading(heading){return heading.closest('.module,.config-card,.status-card,section')||heading.parentElement}
function removeModule(label){var headings=document.querySelectorAll('.module-title,.section-title,.card-title,h2,h3,h4');for(var i=0;i<headings.length;i++){if(clean(headings[i].textContent).includes(label)){var c=cardForHeading(headings[i]);if(c&&c!==document.body)c.remove()}}}
function applyFeatures(){if(document.documentElement.getAttribute('data-cfnew-notifications')!=='1')removeModule('消息通知设置');if(document.documentElement.getAttribute('data-cfnew-logs')!=='1')removeModule('查看操作日志')}
function removeBottomBar(){document.querySelectorAll('.footer,.social-links').forEach(function(x){x.remove()});var ver=Array.from(document.querySelectorAll('button,a,span,div')).find(function(x){return /^v?2\\.1\\.20\\d{6,}$/i.test(clean(x.textContent))&&x.children.length<3});if(ver){var p=ver.closest('footer,.footer,[class*="bottom"],[class*="toolbar"],[class*="nav"],div');if(p&&p.querySelectorAll('button,a').length>=3)p.remove()}}
function visible(el){var r=el.getBoundingClientRect();var st=getComputedStyle(el);return st.display!=='none'&&st.visibility!=='hidden'&&r.width>0&&r.height>0}
function triggerContextSave(){var active=document.activeElement;var scope=active&&active!==document.body?active.closest('.module,.config-card,.status-card,section'):null;function savesIn(s){return Array.from((s||document).querySelectorAll('button,.btn,.button')).filter(function(b){return visible(b)&&/^(保存|保存并应用|保存配置|确定)$/.test(clean(b.textContent))&&!b.closest('#cfnewActionDock')})}var list=scope?savesIn(scope):[];if(!list.length){var all=savesIn(document);var center=innerHeight/2;all.sort(function(a,b){return Math.abs((a.getBoundingClientRect().top+a.getBoundingClientRect().bottom)/2-center)-Math.abs((b.getBoundingClientRect().top+b.getBoundingClientRect().bottom)/2-center)});list=all}if(list[0]){list[0].click();return}var fallback=Array.from(document.querySelectorAll('button')).find(function(b){return visible(b)&&clean(b.textContent).includes('保存')&&!b.closest('#cfnewActionDock')});if(fallback)fallback.click()}
function mountDock(){if(document.getElementById('cfnewActionDock'))return;var dock=document.createElement('div');dock.id='cfnewActionDock';dock.setAttribute('role','group');dock.setAttribute('aria-label','页面操作');var refresh=document.createElement('button');refresh.type='button';refresh.title='刷新';refresh.setAttribute('aria-label','刷新');refresh.innerHTML=icon('refresh');refresh.onclick=function(){location.reload()};var save=document.createElement('button');save.type='button';save.className='cfnew-dock-save';save.title='保存';save.setAttribute('aria-label','保存当前模块');save.innerHTML=icon('save');save.onclick=triggerContextSave;dock.appendChild(refresh);dock.appendChild(save);document.body.appendChild(dock)}
function mountTheme(){if(document.getElementById('cfnewThemeSwitcher')){paint(get(),false);return}var brand=document.createElement('div');brand.className='cfnew-brand';brand.innerHTML='<i></i><b>CFnew</b>';document.body.appendChild(brand);var box=document.createElement('div');box.id='cfnewThemeSwitcher';box.className='cfnew-theme-switcher';box.setAttribute('role','group');box.setAttribute('aria-label','主题模式');var cap=document.createElement('span');cap.textContent='主题';box.appendChild(cap);[['system','跟随系统'],['light','浅色'],['dark','深色']].forEach(function(x){var b=document.createElement('button');b.type='button';b.setAttribute('data-cfnew-mode',x[0]);b.textContent=x[1];b.onclick=function(){paint(x[0],true)};box.appendChild(b)});document.body.appendChild(box);paint(get(),false)}
function rename(){document.querySelectorAll('h1,h2,h3,.header-title,.page-title').forEach(function(el){Array.from(el.childNodes).forEach(function(n){if(n.nodeType===3&&/edgetunnel 设置页面/i.test(n.nodeValue))n.nodeValue=n.nodeValue.replace(/edgetunnel 设置页面/ig,'CFnew 设置中心')})});document.title='CFnew · 设置中心'}
function mount(){rename();applyFeatures();removeBottomBar();decorate(document.body);mountTheme();if(document.documentElement.getAttribute('data-cfnew-page')==='admin')mountDock();var mo=new MutationObserver(function(ms){ms.forEach(function(m){Array.from(m.addedNodes||[]).forEach(function(n){if(n.nodeType===1){decorate(n);applyFeatures();removeBottomBar()}else if(n.nodeType===3&&n.parentElement)stripText(n.parentElement)})})});mo.observe(document.body,{childList:true,subtree:true})}
...
function __CFStyleRemoteHtml(html, kind = 'admin') {
  if (typeof html !== 'string' || !/<html[\s>]/i.test(html) || html.includes('data-cfnew-ui=')) return html;
  const pageKind = kind === 'admin' ? 'admin' : 'simple';
  const notifications = __CF_UI_FEATURES.notifications ? '1' : '0';
  const logs = __CF_UI_FEATURES.logs ? '1' : '0';
  html = html.replace(/<html([^>]*)>/i, `<html$1 data-cfnew-ui="${__CF_UI_VERSION}" data-cfnew-page="${pageKind}" data-cfnew-notifications="${notifications}" data-cfnew-logs="${logs}">`);
...
async function __CFGetStyledStaticPage(path, options = {}) {
  ...
  const html = __CFStyleRemoteHtml(await response.text(), path.startsWith('/admin') ? 'admin' : 'simple');
		...
		if (访问路径 === 'version') {// 版本信息接口
			...
			if ((env.KV || env.C || env.c) && typeof (env.KV || env.C || env.c).get === 'function') {
				...
				if (区分大小写访问路径 === 加密秘钥 && 加密秘钥 !== '勿动此默认密钥，有需求请自行通过添加变量KEY进行修改') {//快速订阅
					...
					return __CFGetStyledStaticPage('/admin' + url.search);
