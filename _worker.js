...
// ===== CFnew UI layer v1.5.0: upstream 2026-08-11 core snapshot + iOS glass UI, Lucide-style vector icons, cool-tone controls, robust scrolling, passive-notice suppression =====
const __CF_UI_VERSION = 'cfnew-ios-glass-edt-v1.5.0';
const __CF_BUNDLED_UI_MODULES = '__CFNEW_UI_MODULES_BUNDLED__';
...
:root{--cf-bg:#eef4fb;--cf-bg2:#e8eff8;--cf-panel:rgba(255,255,255,.60);--cf-panel-strong:rgba(255,255,255,.80);--cf-control:rgba(255,255,255,.72);--cf-control-hover:rgba(255,255,255,.90);--cf-text:#142033;--cf-muted:#66758a;--cf-faint:#93a0b3;--cf-border:rgba(255,255,255,.78);--cf-hairline:rgba(65,88,119,.13);--cf-accent:#4f78ff;--cf-accent2:#7d8cff;--cf-accent-soft:rgba(79,120,255,.12);--cf-accent-press:rgba(79,120,255,.18);--cf-success:#2f9d78;--cf-danger:#cf5d6f;--cf-shadow:0 24px 72px rgba(34,52,78,.13),0 2px 12px rgba(34,52,78,.055);--cf-radius-xl:27px;--cf-radius-lg:20px;--cf-radius-md:14px;--cf-ease:cubic-bezier(.22,1,.36,1)}
html[data-cfnew-theme="dark"]{--cf-bg:#0d1520;--cf-bg2:#121d2b;--cf-panel:rgba(27,39,54,.62);--cf-panel-strong:rgba(31,44,59,.80);--cf-control:rgba(43,57,73,.70);--cf-control-hover:rgba(52,68,86,.86);--cf-text:#edf3fb;--cf-muted:#aab6c5;--cf-faint:#7f8da0;--cf-border:rgba(255,255,255,.10);--cf-hairline:rgba(233,241,252,.11);--cf-accent:#86a4ff;--cf-accent2:#a0adff;--cf-accent-soft:rgba(134,164,255,.14);--cf-accent-press:rgba(134,164,255,.21);--cf-success:#72c7a0;--cf-danger:#ec8b98;--cf-shadow:0 28px 84px rgba(0,0,0,.34),0 3px 14px rgba(0,0,0,.22)}
html{height:auto!important;min-height:100%!important;max-height:none!important;overflow-x:hidden!important;overflow-y:scroll!important;scrollbar-gutter:stable;scroll-behavior:smooth;overscroll-behavior-y:auto!important}body{height:auto!important;min-height:100vh!important;min-height:100dvh!important;max-height:none!important;overflow-x:hidden!important;overflow-y:auto!important;position:relative!important;touch-action:pan-y!important;overscroll-behavior-y:auto!important;font-family:-apple-system,BlinkMacSystemFont,"SF Pro Display","SF Pro Text","Segoe UI","PingFang SC","Microsoft YaHei",Arial,sans-serif!important;background:radial-gradient(circle at 12% 8%,rgba(117,151,235,.20),transparent 33%),radial-gradient(circle at 88% 86%,rgba(144,119,218,.13),transparent 36%),linear-gradient(145deg,var(--cf-bg),var(--cf-bg2))!important;color:var(--cf-text)!important;text-shadow:none!important;-webkit-font-smoothing:antialiased!important}
body:before,body:after{animation:none!important}.page-wrapper,.app-wrapper,.admin-wrapper,.main-wrapper,.main-content,.content-wrapper,.settings-wrapper,.settings-container,#app,#root{height:auto!important;min-height:0!important;max-height:none!important;overflow:visible!important;position:relative!important}.page-wrapper{width:100%!important;max-width:none!important;min-height:100vh!important;padding:58px 18px 104px!important;box-sizing:border-box!important;display:flex!important;align-items:flex-start!important;justify-content:center!important}.card-container{width:min(100%,1120px)!important;max-width:1120px!important;height:auto!important;min-height:0!important;max-height:none!important;margin:0 auto!important;padding:24px!important;border:1px solid var(--cf-border)!important;border-radius:var(--cf-radius-xl)!important;background:linear-gradient(145deg,var(--cf-panel-strong),var(--cf-panel))!important;box-shadow:var(--cf-shadow)!important;backdrop-filter:blur(30px) saturate(145%)!important;-webkit-backdrop-filter:blur(30px) saturate(145%)!important;color:var(--cf-text)!important;overflow:visible!important}.card-container:before,.card-container:after{display:none!important;content:none!important}
.header,.page-header{padding:7px 2px 18px!important;margin:0 0 16px!important;border:0!important;border-top:0!important;border-bottom:1px solid var(--cf-hairline)!important;background:transparent!important;box-shadow:none!important}.header:before,.header:after,.page-header:before,.page-header:after,.header-title:before,.header-title:after{display:none!important;content:none!important;border:0!important;background:none!important}.header h1,.header-title h1,#pageTitle,.page-title{margin:0!important;color:var(--cf-text)!important;background:none!important;-webkit-text-fill-color:currentColor!important;text-shadow:none!important;font-weight:760!important;letter-spacing:-.028em!important}.header p,.header-subtitle,.page-subtitle,.subtitle{color:var(--cf-muted)!important;text-shadow:none!important}.header-buttons{display:flex!important;align-items:center!important;gap:8px!important}.header-buttons button,.header-buttons .btn{min-height:38px!important;padding:0 13px!important;border:1px solid var(--cf-hairline)!important;border-radius:12px!important;background:var(--cf-control)!important;color:var(--cf-text)!important;box-shadow:0 4px 14px rgba(35,52,76,.06)!important;backdrop-filter:blur(16px)!important;-webkit-backdrop-filter:blur(16px)!important}
.module,.network-card,.latency-card,.cf-stats-card,.cf-info-box,.status-card,.config-card{border:1px solid var(--cf-border)!important;border-radius:var(--cf-radius-lg)!important;background:linear-gradient(150deg,var(--cf-panel-strong),var(--cf-panel))!important;box-shadow:0 10px 34px rgba(41,58,82,.07)!important;color:var(--cf-text)!important;backdrop-filter:blur(24px) saturate(135%)!important;-webkit-backdrop-filter:blur(24px) saturate(135%)!important}.module{margin:0 0 14px!important;padding:20px!important;overflow:visible!important}.module:hover,.network-card:hover,.latency-card:hover{border-color:rgba(112,139,180,.28)!important;box-shadow:0 14px 38px rgba(41,58,82,.085)!important}.module-title,.network-card-title,.card-title,.section-title{display:flex!important;align-items:center!important;gap:10px!important;color:var(--cf-text)!important;border-color:var(--cf-hairline)!important;text-shadow:none!important;font-weight:735!important}.module-title:before,.module-title:after{box-shadow:none!important}.form-group label,.form-label,label{color:var(--cf-text)!important;text-shadow:none!important}.hint,.description,.form-hint,.help-text,small,.footer-hint{color:var(--cf-muted)!important}
input,select,textarea,.input-wrapper input,.input-wrapper select,.input-wrapper textarea{box-sizing:border-box!important;background:var(--cf-control)!important;color:var(--cf-text)!important;border:1px solid var(--cf-hairline)!important;border-radius:13px!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.28)!important;text-shadow:none!important;outline:none!important;transition:border-color .2s,box-shadow .2s,background .2s!important}input:hover,select:hover,textarea:hover{background:var(--cf-control-hover)!important}input:focus,select:focus,textarea:focus{border-color:var(--cf-accent)!important;box-shadow:0 0 0 4px var(--cf-accent-soft)!important}input::placeholder,textarea::placeholder{color:var(--cf-faint)!important}select option{background:var(--cf-panel-strong)!important;color:var(--cf-text)!important}.input-wrapper:before,.input-wrapper:after{display:none!important}
button,.btn,.button{font-family:inherit!important;text-shadow:none!important;clip-path:none!important;-webkit-tap-highlight-color:transparent!important}.btn,button[class*="btn"],.button,button{border-radius:12px!important;transition:transform .16s var(--cf-ease),border-color .18s,background .18s,color .18s,box-shadow .18s,filter .18s!important}.btn,button[class*="btn"],.button{border:1px solid var(--cf-hairline)!important;background:var(--cf-control)!important;color:var(--cf-text)!important;box-shadow:0 3px 12px rgba(34,52,78,.045)!important}.btn:hover,button[class*="btn"]:hover,.button:hover,.header-buttons button:hover{transform:translateY(-1px)!important;border-color:rgba(79,120,255,.26)!important;background:var(--cf-accent-soft)!important;color:var(--cf-accent)!important;box-shadow:0 7px 18px rgba(54,79,120,.09)!important}.btn:active,button[class*="btn"]:active,.button:active,.header-buttons button:active,.cfnew-float-actions button:active,.cfnew-theme-switcher button:active{transform:scale(.965)!important;background:var(--cf-accent-press)!important;box-shadow:inset 0 1px 2px rgba(34,52,78,.10)!important}.btn:focus-visible,button:focus-visible,.button:focus-visible{outline:none!important;box-shadow:0 0 0 4px var(--cf-accent-soft)!important;border-color:var(--cf-accent)!important}.btn-primary,.primary-btn,.save-btn,.login-btn,.btn-success{background:linear-gradient(135deg,var(--cf-accent),var(--cf-accent2))!important;border-color:transparent!important;color:#fff!important;box-shadow:0 9px 24px rgba(79,120,255,.22)!important}.btn-primary:hover,.primary-btn:hover,.save-btn:hover,.login-btn:hover,.btn-success:hover{color:#fff!important;filter:brightness(1.035)!important}.btn-danger,.danger-btn{background:rgba(208,92,109,.10)!important;border-color:rgba(208,92,109,.18)!important;color:var(--cf-danger)!important}.btn-secondary,.secondary-btn{background:var(--cf-control)!important;color:var(--cf-text)!important}.status-success,.success,.online{color:var(--cf-success)!important}.status-error,.error,.danger,.offline{color:var(--cf-danger)!important}.badge,.tag,.status-badge{border-color:var(--cf-hairline)!important;background:var(--cf-accent-soft)!important;color:var(--cf-accent)!important;box-shadow:none!important}
.modal-overlay,.overlay{background:rgba(15,23,33,.34)!important;backdrop-filter:blur(12px)!important;-webkit-backdrop-filter:blur(12px)!important}.modal,.modal-content,.dialog{border:1px solid var(--cf-border)!important;border-radius:22px!important;background:linear-gradient(150deg,var(--cf-panel-strong),var(--cf-panel))!important;color:var(--cf-text)!important;box-shadow:var(--cf-shadow)!important;backdrop-filter:blur(28px) saturate(140%)!important;-webkit-backdrop-filter:blur(28px) saturate(140%)!important}.tabs,.tab-list,.header-buttons,.button-group,.module-footer{gap:8px!important}.tab,.tab-button{border-radius:11px!important;color:var(--cf-muted)!important}.tab.active,.tab-button.active{background:var(--cf-accent-soft)!important;color:var(--cf-accent)!important}.subscription-link-wrapper,.link-wrapper,.code-block,pre{border:1px solid var(--cf-hairline)!important;border-radius:13px!important;background:var(--cf-control)!important;color:var(--cf-text)!important}.qr-code,.qrcode{border:1px solid var(--cf-hairline)!important;border-radius:15px!important;background:#fff!important;padding:8px!important}
#background-iframe,#blur-overlay,.background-iframe,.background-video,.particles,.matrix-bg,.matrix-code-rain{display:none!important}.cfnew-brand{position:fixed;top:15px;left:18px;z-index:2147483000;display:flex;align-items:center;gap:8px;padding:8px 12px;border:1px solid var(--cf-border);border-radius:14px;background:var(--cf-panel);box-shadow:0 10px 34px rgba(28,39,53,.09);backdrop-filter:blur(24px) saturate(140%);-webkit-backdrop-filter:blur(24px) saturate(140%);color:var(--cf-text);font-size:12px;font-weight:760;letter-spacing:.02em}.cfnew-brand-mark{width:20px;height:20px;display:grid;place-items:center;border-radius:7px;background:linear-gradient(145deg,var(--cf-accent),var(--cf-accent2));color:#fff}.cfnew-theme-switcher{position:fixed;top:15px;right:18px;z-index:2147483000;display:flex;align-items:center;gap:3px;padding:6px;border:1px solid var(--cf-border);border-radius:14px;background:var(--cf-panel);box-shadow:0 10px 34px rgba(28,39,53,.09);backdrop-filter:blur(24px) saturate(140%);-webkit-backdrop-filter:blur(24px) saturate(140%)}.cfnew-theme-switcher span{color:var(--cf-muted);font-size:11px;font-weight:650;padding:0 5px}.cfnew-theme-switcher button{min-width:0!important;padding:7px 9px!important;border:1px solid transparent!important;border-radius:9px!important;background:transparent!important;color:var(--cf-muted)!important;font-size:12px!important;font-weight:650!important;cursor:pointer!important}.cfnew-theme-switcher button:hover{background:var(--cf-accent-soft)!important;color:var(--cf-accent)!important;border-color:rgba(79,120,255,.14)!important}.cfnew-theme-switcher button.is-active{background:var(--cf-control)!important;color:var(--cf-accent)!important;border-color:var(--cf-hairline)!important;box-shadow:0 1px 5px rgba(30,45,65,.10)!important}
.cfnew-icon{width:18px;height:18px;display:inline-flex;align-items:center;justify-content:center;flex:0 0 18px;color:currentColor;vertical-align:-3px}.cfnew-icon svg{width:100%;height:100%;display:block;fill:none;stroke:currentColor;stroke-width:1.72;stroke-linecap:round;stroke-linejoin:round}.module-title>.cfnew-icon,.section-title>.cfnew-icon,.card-title>.cfnew-icon,.network-card-title>.cfnew-icon,h2>.cfnew-icon,h3>.cfnew-icon{width:30px;height:30px;flex:0 0 30px;padding:6px;box-sizing:border-box;border:1px solid rgba(79,120,255,.14);border-radius:9px;background:linear-gradient(145deg,var(--cf-accent-soft),rgba(255,255,255,.08));color:var(--cf-accent);box-shadow:inset 0 1px rgba(255,255,255,.22)}.cfnew-inline-icon{margin-right:6px}.header-buttons .cfnew-icon,button .cfnew-icon,.btn .cfnew-icon{width:17px;height:17px;flex-basis:17px}.cfnew-float-actions{position:fixed;right:22px;bottom:22px;z-index:2147482990;display:flex;align-items:center;gap:8px;padding:7px;border:1px solid var(--cf-border);border-radius:18px;background:var(--cf-panel);box-shadow:0 18px 48px rgba(34,52,78,.18);backdrop-filter:blur(26px) saturate(145%);-webkit-backdrop-filter:blur(26px) saturate(145%)}.cfnew-float-actions button{width:44px;height:44px;display:grid;place-items:center;padding:0!important;border:1px solid var(--cf-hairline)!important;border-radius:13px!important;background:var(--cf-control)!important;color:var(--cf-text)!important;cursor:pointer!important;box-shadow:0 4px 14px rgba(34,52,78,.06)!important}.cfnew-float-actions button:hover{background:var(--cf-accent-soft)!important;color:var(--cf-accent)!important;border-color:rgba(79,120,255,.24)!important}.cfnew-float-actions button[data-action="save"]{width:auto;min-width:92px;padding:0 16px!important;grid-auto-flow:column;gap:8px;background:linear-gradient(135deg,var(--cf-accent),var(--cf-accent2))!important;color:#fff!important;border-color:transparent!important;box-shadow:0 10px 24px rgba(79,120,255,.22)!important}.cfnew-float-actions .cfnew-icon{width:19px;height:19px}.cfnew-toast{position:fixed;left:50%;bottom:82px;z-index:2147483001;transform:translate(-50%,12px);opacity:0;pointer-events:none;padding:10px 14px;border:1px solid var(--cf-border);border-radius:13px;background:var(--cf-panel-strong);box-shadow:0 12px 34px rgba(34,52,78,.16);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);color:var(--cf-text);font-size:13px;font-weight:650;transition:.2s}.cfnew-toast.is-show{opacity:1;transform:translate(-50%,0)}
footer,.footer,.social-links,.fixed-footer,.bottom-bar,.footer-actions{display:none!important}html[data-cfnew-page="simple"] .card-container{width:min(100%,520px)!important;max-width:520px!important;margin-top:max(4vh,20px)!important;padding:30px!important}html[data-cfnew-page="simple"] .page-wrapper{align-items:center!important}html[data-cfnew-page="simple"] .page-form{display:grid!important;gap:14px!important}html[data-cfnew-page="simple"] .btn,html[data-cfnew-page="simple"] button[type="submit"]{min-height:44px!important;width:100%!important}
*{scrollbar-width:thin;scrollbar-color:rgba(110,132,163,.42) transparent}::-webkit-scrollbar{width:10px;height:10px}::-webkit-scrollbar-track{background:transparent}::-webkit-scrollbar-thumb{background:rgba(110,132,163,.34);border:3px solid transparent;border-radius:999px;background-clip:padding-box}::-webkit-scrollbar-thumb:hover{background:rgba(110,132,163,.52);border:3px solid transparent;background-clip:padding-box}
@media(max-width:760px){.page-wrapper{padding:62px 9px 104px!important}.card-container{padding:14px!important;border-radius:20px!important}.module{padding:15px!important;border-radius:17px!important}.cfnew-brand{left:9px;top:9px}.cfnew-theme-switcher{right:9px;top:9px}.cfnew-theme-switcher span{display:none}.cfnew-theme-switcher button{padding:6px 7px!important;font-size:11px!important}.header-buttons{flex-wrap:wrap!important}.cfnew-float-actions{right:10px;bottom:10px}.cfnew-float-actions button{width:42px;height:42px}.cfnew-float-actions button[data-action="save"]{min-width:82px;padding:0 13px!important}input,select,textarea{font-size:16px!important}}
@media(prefers-reduced-motion:reduce){*,*:before,*:after{scroll-behavior:auto!important;animation:none!important;transition:none!important}}
/* CFnew v1.5: cool glass interaction language; all decorative pictographs are replaced by embedded vector icons. */
.btn-warning,.warning-btn,.alert-warning,.warning,.notice,.tip,.hint-box,.info-tip,[class*="warning"],[class*="orange"]{--warning-color:var(--cf-accent)!important;--warning-bg:var(--cf-accent-soft)!important;--warning-border:rgba(79,120,255,.22)!important}
button[style*="#ff9" i],button[style*="#ffa" i],button[style*="#f59" i],button[style*="orange" i],button[style*="yellow" i],.toggle-button,.collapse-button,.collapse-btn,.module-toggle,.section-toggle,.expand-button,.expand-btn{color:var(--cf-accent)!important;background:var(--cf-control)!important;border-color:rgba(79,120,255,.20)!important;box-shadow:0 4px 14px rgba(34,52,78,.06)!important}
button[style*="#ff9" i]:hover,button[style*="#ffa" i]:hover,button[style*="#f59" i]:hover,button[style*="orange" i]:hover,button[style*="yellow" i]:hover,.toggle-button:hover,.collapse-button:hover,.collapse-btn:hover,.module-toggle:hover,.section-toggle:hover,.expand-button:hover,.expand-btn:hover{color:var(--cf-accent)!important;background:var(--cf-accent-soft)!important;border-color:rgba(79,120,255,.30)!important}
.cfnew-module-suppressed,.cfnew-passive-suppressed,.cfnew-footer-suppressed{display:none!important;visibility:hidden!important;pointer-events:none!important}
.collapse-icon,.module.collapsed .collapse-icon,.module.network-detail-collapsed .collapse-icon,.module-title:not(.non-collapsible):hover .collapse-icon{background:var(--cf-accent-soft)!important;border:1px solid rgba(79,120,255,.22)!important;fill:var(--cf-accent)!important;color:var(--cf-accent)!important;box-shadow:0 3px 10px rgba(54,79,120,.08)!important}.collapse-section{border-left-color:rgba(79,120,255,.28)!important}.inline-hint-btn{background:var(--cf-accent-soft)!important;color:var(--cf-accent)!important;border-color:rgba(79,120,255,.20)!important}.inline-hint-btn:hover{background:var(--cf-accent-press)!important;color:var(--cf-accent)!important;border-color:rgba(79,120,255,.30)!important}
/* passive upstream announcements are opt-in via CFNEW_UI_MODULES=notices */
html:not([data-cfnew-modules*="notifications"]) .module:has(#telegramEnabled){display:none!important}html:not([data-cfnew-modules*="logs"]) .module:has(#logsContainer){display:none!important}html:not([data-cfnew-modules*="notices"]) .notice-banner,html:not([data-cfnew-modules*="notices"]) .announcement,html:not([data-cfnew-modules*="notices"]) .announcement-bar,html:not([data-cfnew-modules*="notices"]) .info-banner,html:not([data-cfnew-modules*="notices"]) .tip-banner,html:not([data-cfnew-modules*="notices"]) .toast-container,html:not([data-cfnew-modules*="notices"]) .snackbar-container,html:not([data-cfnew-modules*="notices"]) .inline-hint-btn,html:not([data-cfnew-modules*="notices"]) .btn-ech-help,html:not([data-cfnew-modules*="notices"]) .btn-proxyip-help,html:not([data-cfnew-modules*="notices"]) .btn-path-template-config,html:not([data-cfnew-modules*="notices"]) .btn-search-proxy,html:not([data-cfnew-modules*="notices"]) .hint-button,html:not([data-cfnew-modules*="notices"]) .help-link,html:not([data-cfnew-modules*="notices"]) .help-button{display:none!important}
</style>`;
const __CF_UI_RUNTIME = `<script id="cfnew-ui-runtime">(function(){
var K='cfnew-theme-mode',Q=window.matchMedia?window.matchMedia('(prefers-color-scheme: dark)'):null,RUN=false,observer=null;
function get(){try{var m=localStorage.getItem(K)||'system';return /^(system|light|dark)$/.test(m)?m:'system'}catch(e){return'system'}}
function res(m){return m==='system'?(Q&&Q.matches?'dark':'light'):m}
function paint(m,save){if(!/^(system|light|dark)$/.test(m))m='system';document.documentElement.setAttribute('data-cfnew-theme-mode',m);document.documentElement.setAttribute('data-cfnew-theme',res(m));document.documentElement.style.colorScheme=res(m);if(save)try{localStorage.setItem(K,m)}catch(e){}document.querySelectorAll('[data-cfnew-mode]').forEach(function(b){b.classList.toggle('is-active',b.getAttribute('data-cfnew-mode')===m)})}
var icons={
wifi:'<path d="M4.3 9.4a12 12 0 0 1 15.4 0"></path><path d="M7.3 12.4a7.5 7.5 0 0 1 9.4 0"></path><path d="M10.2 15.3a3.2 3.2 0 0 1 3.6 0"></path><circle cx="12" cy="18.2" r=".8" fill="currentColor" stroke="none"></circle>',
globe:'<circle cx="12" cy="12" r="9"></circle><path d="M3 12h18M12 3a14.5 14.5 0 0 1 0 18M12 3a14.5 14.5 0 0 0 0 18"></path>',
link2:'<path d="M9.4 14.6l5.2-5.2"></path><path d="M7.1 16.9l-1.4 1.4a3.6 3.6 0 0 1-5.1-5.1l3-3a3.6 3.6 0 0 1 5.1 0"></path><path d="M16.9 7.1l1.4-1.4a3.6 3.6 0 0 1 5.1 5.1l-3 3a3.6 3.6 0 0 1-5.1 0"></path>',
wand:'<path d="M4 20L15.5 8.5"></path><path d="M14 4l.7 2.1L17 7l-2.3.9L14 10l-.8-2.1L11 7l2.2-.9L14 4z"></path><path d="M20 11l.5 1.5L22 13l-1.5.5L20 15l-.5-1.5L18 13l1.5-.5L20 11z"></path><path d="M5 3l.5 1.5L7 5l-1.5.5L5 7l-.5-1.5L3 5l1.5-.5L5 3z"></path>',
sliders:'<path d="M4 7h10M18 7h2M4 17h2M10 17h10"></path><circle cx="16" cy="7" r="2"></circle><circle cx="8" cy="17" r="2"></circle><path d="M4 12h4M12 12h8"></path><circle cx="10" cy="12" r="2"></circle>',
keyhole:'<rect x="5" y="8.5" width="14" height="11.5" rx="3"></rect><path d="M8.5 8.5V6.7a3.5 3.5 0 0 1 7 0v1.8"></path><circle cx="12" cy="14" r="1.4"></circle><path d="M12 15.4v1.8"></path>',
cloudbolt:'<path d="M7 18h10a4 4 0 0 0 .6-7.9A6 6 0 0 0 6 8.6 4.6 4.6 0 0 0 7 18z"></path><path d="M13 11l-2.2 3h2l-1.2 3 3.2-4h-2L13 11z"></path>',
repeat:'<path d="M17 7H7a4 4 0 0 0-4 4"></path><path d="M14 4l3 3-3 3"></path><path d="M7 17h10a4 4 0 0 0 4-4"></path><path d="M10 20l-3-3 3-3"></path>',
bell:'<path d="M18 9a6 6 0 0 0-12 0c0 5-2.2 6.2-2.2 8h16.4C20.2 15.2 18 14 18 9z"></path><path d="M10 20h4"></path>',
list:'<path d="M9 6h11M9 12h11M9 18h11"></path><circle cx="4.5" cy="6" r=".8" fill="currentColor" stroke="none"></circle><circle cx="4.5" cy="12" r=".8" fill="currentColor" stroke="none"></circle><circle cx="4.5" cy="18" r=".8" fill="currentColor" stroke="none"></circle>',
scan:'<path d="M4 9V5a1 1 0 0 1 1-1h4M15 4h4a1 1 0 0 1 1 1v4M20 15v4a1 1 0 0 1-1 1h-4M9 20H5a1 1 0 0 1-1-1v-4"></path><rect x="8" y="8" width="3" height="3" rx=".5"></rect><rect x="13" y="13" width="3" height="3" rx=".5"></rect>',
copy:'<rect x="8" y="8" width="11" height="11" rx="2.5"></rect><path d="M16 8V5.5A2.5 2.5 0 0 0 13.5 3h-8A2.5 2.5 0 0 0 3 5.5v8A2.5 2.5 0 0 0 5.5 16H8"></path>',
check:'<path d="M5 12.5l4.1 4.1L19 6.8"></path>',
refresh:'<path d="M20 6v5h-5"></path><path d="M18.4 9A7 7 0 1 0 19 14"></path>',
doorout:'<path d="M10 4H5v16h5"></path><path d="M14 8l4 4-4 4M9 12h9"></path>',
undo:'<path d="M7 7H3v-4"></path><path d="M3.5 7.5A8 8 0 1 1 4 17"></path>',
help:'<circle cx="12" cy="12" r="9"></circle><path d="M9.7 9a2.4 2.4 0 1 1 3.7 2c-1 .7-1.4 1.1-1.4 2.3"></path><circle cx="12" cy="17" r=".8" fill="currentColor" stroke="none"></circle>',
branch:'<circle cx="6" cy="5" r="2"></circle><circle cx="18" cy="7" r="2"></circle><circle cx="6" cy="19" r="2"></circle><path d="M6 7v10M8 8h4a4 4 0 0 1 4 4v3"></path>',
search:'<circle cx="10.5" cy="10.5" r="6.5"></circle><path d="M15.5 15.5L21 21"></path>',
shield:'<path d="M12 3l7 3v5c0 5-3 8-7 10-4-2-7-5-7-10V6l7-3z"></path><path d="M9.4 12.2l1.8 1.8 3.8-4"></path>',
layers:'<path d="M12 3l8 4.5-8 4.5-8-4.5L12 3z"></path><path d="M4 12l8 4.5 8-4.5M4 16.5l8 4.5 8-4.5"></path>',
sparkles:'<path d="M12 3l1.1 3.2L16 7.3l-2.9 1.1L12 12l-1.1-3.6L8 7.3l2.9-1.1L12 3z"></path><path d="M19 13l.7 2.1L22 16l-2.3.9L19 19l-.8-2.1L16 16l2.2-.9L19 13z"></path><path d="M5 13l.7 2.1L8 16l-2.3.9L5 19l-.8-2.1L2 16l2.2-.9L5 13z"></path>',
info:'<circle cx="12" cy="12" r="9"></circle><path d="M12 11v6"></path><circle cx="12" cy="7.5" r=".8" fill="currentColor" stroke="none"></circle>',
...
xmark:'<path d="M7 7l10 10M17 7L7 17"></path>',
chevron:'<path d="M8 10l4 4 4-4"></path>'};
function icon(name,extra){return '<span class="cfnew-icon '+(extra||'')+'" aria-hidden="true"><svg viewBox="0 0 24 24">'+(icons[name]||icons.help)+'</svg></span>'}
function iconFor(text){var t=(text||'').toLowerCase();if(/全球|海外|国外|国家|地理|位置|location/.test(t))return'globe';if(/当前网络|网络信息|墙外|国内测试|网络/.test(t))return'wifi';if(/节点链接|复制节点|link/.test(t))return t.indexOf('复制')>=0?'copy':'link2';if(/优选|开始优选/.test(t))return'sparkles';if(/小白|简单/.test(t))return'wand';if(/详细|配置|参数|设置|模板/.test(t))return'sliders';if(/ech|encrypted|加密/.test(t))return'keyhole';if(/cloudflare|cdn|proxyip/.test(t))return'cloudbolt';if(/订阅转换/.test(t))return'repeat';if(/刷新|更新/.test(t))return'refresh';if(/重置/.test(t))return'undo';if(/消息|通知|telegram/.test(t))return'bell';if(/日志|清单|列表/.test(t))return'list';if(/二维码/.test(t))return'scan';if(/复制/.test(t))return'copy';if(/保存|确定|应用/.test(t))return'check';if(/退出/.test(t))return'doorout';if(/链式|路由/.test(t))return'branch';if(/获取更多|搜索|验证/.test(t))return'search';if(/socks|安全|证书/.test(t))return'shield';if(/清除|删除/.test(t))return'trash';if(/提示|说明|为什么/.test(t))return'info';if(/^[‹<\u25C0←]/.test(t))return'chevronleft';if(/^[›>\u25B6→]/.test(t))return'chevronright';if(/关闭|取消/.test(t))return'xmark';return'help'}
function emojiRegex(){return /[\p{Extended_Pictographic}\p{Regional_Indicator}\p{Emoji_Modifier}\uFE0F\u200D\u20E3\u{E0020}-\u{E007E}]/gu}
function emojiLeadRegex(){return /^\s*(?:[\p{Extended_Pictographic}\p{Regional_Indicator}\p{Emoji_Modifier}\uFE0F\u200D\u20E3\u{E0020}-\u{E007E}])+/u}
function hasEmoji(s){return emojiRegex().test(String(s||''))}
function stripEmoji(s){return String(s||'').replace(emojiRegex(),'').replace(/\s{2,}/g,' ').trim()}
function retitle(){document.title='CFnew · 设置中心';document.querySelectorAll('h1,h2,.page-title,#pageTitle,.header-title').forEach(function(el){var t=stripEmoji(el.textContent);if(/edgetunnel\s*设置页面/i.test(t)||t==='管理后台'||t==='加载中...')el.textContent='CFnew 设置中心';else if(/关于\s*edgetunnel/i.test(t))el.textContent='关于 CFnew 核心'})}
function addSemanticIcons(){var sel='.module-title,.section-title,.card-title,.network-card-title,h1,h2,h3,h4,button,a.btn,button[class*="btn"]';document.querySelectorAll(sel).forEach(function(el){if(el.dataset.cfnewIconDone)return;var original=String(el.textContent||'');var raw=stripEmoji(original);if(!raw)return;var hadEmoji=emojiRegex().test(original);var cls=String(el.className||'');var isHeading=/module-title|section-title|card-title|network-card-title/.test(cls)||/^(H1|H2|H3|H4)$/.test(el.tagName);var special=/^[‹›<>\u25C0\u25B6←→⌃⌄]$/.test(raw);var should=isHeading||hadEmoji||special||/二维码|复制|保存|退出|重置|参数配置|清除配置|路径模板|获取更多|为什么|开始优选|订阅接口|链式代理|我是小白/.test(raw);if(!should)return;if(special){el.innerHTML=icon(iconFor(raw));el.setAttribute('aria-label',raw);el.setAttribute('title',raw)}else{stripElementEmoji(el);el.insertAdjacentHTML('afterbegin',icon(iconFor(raw),'cfnew-inline-icon'))}el.dataset.cfnewIconDone='1'})}function stripElementEmoji(el){var w=document.createTreeWalker(el,NodeFilter.SHOW_TEXT),n;while(n=w.nextNode()){var v=n.nodeValue||'',x=v.replace(emojiRegex(),'');if(x!==v)n.nodeValue=x}}
function hasDirectIcon(el){if(!el||!el.children)return false;for(var i=0;i<el.children.length;i++){if(el.children[i].classList&&el.children[i].classList.contains('cfnew-icon'))return true}return false}
function prependVectorIcon(el,name){if(!el||hasDirectIcon(el))return;var t=document.createElement('template');t.innerHTML=icon(name,'cfnew-inline-icon');var node=t.content.firstElementChild;if(node)el.insertBefore(node,el.firstChild)}
function replaceAllEmojiWithIcons(){var w=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT),nodes=[],n;while(n=w.nextNode()){if(n.parentElement&&n.parentElement.closest('script,style,textarea,pre,code,option'))continue;var v=n.nodeValue||'';if(hasEmoji(v))nodes.push(n)}nodes.forEach(function(node){var v=node.nodeValue||'',p=node.parentElement;if(!p)return;var host=p.closest('button,a.btn,a.button,.btn,.button,.module-title,.section-title,.card-title,.network-card-title,h1,h2,h3,h4,label,strong,b')||p;var raw=stripEmoji(host.textContent||v);var decorative=emojiLeadRegex().test(v)||/^(BUTTON|A|H1|H2|H3|H4|LABEL|STRONG|B)$/.test(host.tagName)||/module-title|section-title|card-title|network-card-title/.test(String(host.className||''));if(decorative&&raw&&!hasDirectIcon(host))prependVectorIcon(host,iconFor(raw));node.nodeValue=v.replace(emojiRegex(),'')})}
function stripAllEmoji(){replaceAllEmojiWithIcons()}
function setSuppressed(el,suppressed,kind){if(!el)return;var cls=kind||'cfnew-module-suppressed';el.classList.toggle(cls,!!suppressed);if(suppressed)el.setAttribute('aria-hidden','true');else el.removeAttribute('aria-hidden')}
function suppressPassiveNotices(){var enabled=(document.documentElement.getAttribute('data-cfnew-modules')||'').split(',').map(function(x){return x.trim()});var suppress=enabled.indexOf('notices')<0;var explicit='.notice-banner,.announcement,.announcement-bar,.info-banner,.tip-banner,.toast-container,.snackbar-container,.inline-hint-btn,.btn-ech-help,.btn-proxyip-help,.btn-path-template-config,.btn-search-proxy,.hint-button,.help-link,.help-button,.tip,.hint-box';document.querySelectorAll(explicit).forEach(function(el){if(!el.closest('.modal,.dialog,[role="dialog"]'))setSuppressed(el,suppress,'cfnew-passive-suppressed')});document.querySelectorAll('button,a,p,small,span').forEach(function(el){if(el.closest('.modal,.dialog,[role="dialog"],.module-title,.section-title')||el.querySelector('input,select,textarea,button,a'))return;var t=stripEmoji(el.textContent);if(t.length>0&&t.length<260&&(/^(提示|温馨提示|公告|注意)[：:]/.test(t)||/为什么需要|是什么[？?]?$|获取更多\s*PROXYIP|国内测试 是由您梯子的/.test(t)||/发现新版本|当前版本已是最新版本|更新提示|版本更新|已有新版本|检查更新完成/.test(t))){var box=el.closest('.inline-hint-btn,.hint-button,.help-link,.help-button,.notice,.tip,.hint-box,.alert,.info-box,.description-box')||el;setSuppressed(box,suppress,'cfnew-passive-suppressed')}})}
function findSection(label){var nodes=document.querySelectorAll('.module-title,.section-title,.card-title,h2,h3,h4');for(var i=0;i<nodes.length;i++){if(stripEmoji(nodes[i].textContent).indexOf(label)>=0)return nodes[i].closest('.module,.config-card,.card,section')||nodes[i].parentElement}var blocks=document.querySelectorAll('.module,.config-card,.card,section');var best=null,bestLen=1/0;for(var j=0;j<blocks.length;j++){var t=stripEmoji(blocks[j].textContent);if(t.indexOf(label)>=0&&t.length<bestLen){best=blocks[j];bestLen=t.length}}return best}
function modules(){var enabled=(document.documentElement.getAttribute('data-cfnew-modules')||'').split(',').map(function(x){return x.trim()});setSuppressed(findSection('消息通知设置'),enabled.indexOf('notifications')<0);setSuppressed(findSection('查看操作日志'),enabled.indexOf('logs')<0);suppressPassiveNotices()}
function suppressBottomActions(){document.querySelectorAll('footer,.footer,.social-links,.fixed-footer,.bottom-bar,.footer-actions').forEach(function(el){setSuppressed(el,true,'cfnew-footer-suppressed')});document.querySelectorAll('body *').forEach(function(el){if(el.id==='cfnewThemeSwitcher'||el.classList.contains('cfnew-float-actions'))return;var st;try{st=getComputedStyle(el)}catch(e){return}if(st.position!=='fixed'&&st.position!=='sticky')return;var r=el.getBoundingClientRect();if(r.bottom<innerHeight-90)return;var txt=stripEmoji(el.textContent);var links=el.querySelectorAll?el.querySelectorAll('a[href*="github"],a[href*="t.me"],a[href*="telegram"]'):[];if(links.length||/版本|更新日志|github|telegram/i.test(txt))setSuppressed(el,true,'cfnew-footer-suppressed')})}
function imp(el,key,val){if(!el)return;if(el.style.getPropertyValue(key)!==val||el.style.getPropertyPriority(key)!=='important')el.style.setProperty(key,val,'important')}
function forceScroll(){var de=document.documentElement,b=document.body;imp(de,'height','auto');imp(de,'min-height','100%');imp(de,'max-height','none');imp(de,'overflow-x','hidden');imp(de,'overflow-y','scroll');imp(b,'height','auto');imp(b,'min-height','100vh');imp(b,'max-height','none');imp(b,'overflow-x','hidden');imp(b,'overflow-y','auto');imp(b,'position','relative');var sels=['.page-wrapper','.app-wrapper','.admin-wrapper','.main-wrapper','.main-content','.content-wrapper','.settings-wrapper','.settings-container','#app','#root','.card-container'];sels.forEach(function(s){document.querySelectorAll(s).forEach(function(el){imp(el,'height','auto');imp(el,'max-height','none');imp(el,'overflow','visible')})});if(de.scrollHeight<=innerHeight&&b&&b.scrollHeight>innerHeight)imp(de,'min-height',b.scrollHeight+'px')}
function toast(text){var enabled=(document.documentElement.getAttribute('data-cfnew-modules')||'').split(',');if(enabled.indexOf('notices')<0)return;var t=document.getElementById('cfnewToast');if(!t){t=document.createElement('div');t.id='cfnewToast';t.className='cfnew-toast';document.body.appendChild(t)}t.textContent=stripEmoji(text);t.classList.add('is-show');clearTimeout(t._timer);t._timer=setTimeout(function(){t.classList.remove('is-show')},1800)}
function visible(el){if(!el||el.disabled)return false;var s=getComputedStyle(el),r=el.getBoundingClientRect();return s.display!=='none'&&s.visibility!=='hidden'&&r.width>0&&r.height>0&&!el.closest('.modal,.modal-overlay,.dialog,[role="dialog"]')}
async function saveAll(){var own=document.querySelector('.cfnew-float-actions [data-action="save"]');if(own)own.disabled=true;var candidates=Array.prototype.filter.call(document.querySelectorAll('button,.btn'),function(b){return b!==own&&stripEmoji(b.textContent)==='保存'&&visible(b)});if(!candidates.length){var exact=Array.prototype.find.call(document.querySelectorAll('button,.btn'),function(b){return b!==own&&/保存全部/.test(stripEmoji(b.textContent))&&visible(b)});if(exact)candidates=[exact]}if(!candidates.length){toast('当前没有可保存的配置');if(own)own.disabled=false;return}for(var i=0;i<candidates.length;i++){candidates[i].click();await new Promise(function(r){setTimeout(r,140)})}toast('已提交当前页面配置');if(own)own.disabled=false}
function mountFloat(){if(document.documentElement.getAttribute('data-cfnew-page')!=='admin'||document.querySelector('.cfnew-float-actions'))return;var box=document.createElement('div');box.className='cfnew-float-actions';box.setAttribute('aria-label','页面快捷操作');var refresh=document.createElement('button');refresh.type='button';refresh.title='刷新页面';refresh.setAttribute('aria-label','刷新页面');refresh.innerHTML=icon('refresh');refresh.onclick=function(){location.reload()};var save=document.createElement('button');save.type='button';save.dataset.action='save';save.title='保存全部可见配置';save.innerHTML=icon('check')+'<span>保存</span>';save.onclick=saveAll;box.appendChild(refresh);box.appendChild(save);document.body.appendChild(box)}
function mountTheme(){if(document.getElementById('cfnewThemeSwitcher')){paint(get(),false);return}var brand=document.createElement('div');brand.className='cfnew-brand';brand.innerHTML='<span class="cfnew-brand-mark">'+icon('layers')+'</span><b>CFnew</b>';document.body.appendChild(brand);var box=document.createElement('div');box.id='cfnewThemeSwitcher';box.className='cfnew-theme-switcher';box.setAttribute('role','group');box.setAttribute('aria-label','主题模式');var cap=document.createElement('span');cap.textContent='主题';box.appendChild(cap);[['system','跟随系统'],['light','浅色'],['dark','深色']].forEach(function(x){var b=document.createElement('button');b.type='button';b.setAttribute('data-cfnew-mode',x[0]);b.textContent=x[1];b.onclick=function(){paint(x[0],true)};box.appendChild(b)});document.body.appendChild(box);paint(get(),false)}
function enhance(){if(RUN)return;RUN=true;try{retitle();modules();addSemanticIcons();stripAllEmoji();suppressBottomActions();mountTheme();mountFloat();forceScroll();retitle()}finally{RUN=false}}
function watch(){if(observer)return;observer=new MutationObserver(function(){if(RUN)return;requestAnimationFrame(enhance)});observer.observe(document.body,{subtree:true,childList:true,characterData:true,attributes:true,attributeFilter:['style','class']})}
function mount(){enhance();watch();setTimeout(forceScroll,120);setTimeout(forceScroll,600);window.addEventListener('resize',forceScroll,{passive:true})}
if(Q){var c=function(){if(get()==='system')paint('system',false)};if(Q.addEventListener)Q.addEventListener('change',c);else if(Q.addListener)Q.addListener(c)}if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',mount,{once:true});else mount()
})();</script>`;
function __CFNormalizeModules(value) {
  const allowed = new Set(['notifications', 'logs', 'notices']);
  return String(value || '').split(',').map(v => v.trim().toLowerCase()).filter(v => allowed.has(v)).join(',');
}
const __CF_SERVER_ICON_PATHS = Object.freeze({
  wifi:'<path d="M4.3 9.4a12 12 0 0 1 15.4 0"></path><path d="M7.3 12.4a7.5 7.5 0 0 1 9.4 0"></path><path d="M10.2 15.3a3.2 3.2 0 0 1 3.6 0"></path><circle cx="12" cy="18.2" r=".8" fill="currentColor" stroke="none"></circle>',
  globe:'<circle cx="12" cy="12" r="9"></circle><path d="M3 12h18M12 3a14.5 14.5 0 0 1 0 18M12 3a14.5 14.5 0 0 0 0 18"></path>',
  link2:'<path d="M9.4 14.6l5.2-5.2"></path><path d="M7.1 16.9l-1.4 1.4a3.6 3.6 0 0 1-5.1-5.1l3-3a3.6 3.6 0 0 1 5.1 0"></path><path d="M16.9 7.1l1.4-1.4a3.6 3.6 0 0 1 5.1 5.1l-3 3a3.6 3.6 0 0 1-5.1 0"></path>',
  sparkles:'<path d="M12 3l1.1 3.2L16 7.3l-2.9 1.1L12 12l-1.1-3.6L8 7.3l2.9-1.1L12 3z"></path><path d="M19 13l.7 2.1L22 16l-2.3.9L19 19l-.8-2.1L16 16l2.2-.9L19 13z"></path><path d="M5 13l.7 2.1L8 16l-2.3.9L5 19l-.8-2.1L2 16l2.2-.9L5 13z"></path>',
  wand:'<path d="M4 20L15.5 8.5"></path><path d="M14 4l.7 2.1L17 7l-2.3.9L14 10l-.8-2.1L11 7l2.2-.9L14 4z"></path>',
  sliders:'<path d="M4 7h10M18 7h2M4 17h2M10 17h10"></path><circle cx="16" cy="7" r="2"></circle><circle cx="8" cy="17" r="2"></circle><path d="M4 12h4M12 12h8"></path><circle cx="10" cy="12" r="2"></circle>',
  keyhole:'<rect x="5" y="8.5" width="14" height="11.5" rx="3"></rect><path d="M8.5 8.5V6.7a3.5 3.5 0 0 1 7 0v1.8"></path><circle cx="12" cy="14" r="1.4"></circle><path d="M12 15.4v1.8"></path>',
  cloudbolt:'<path d="M7 18h10a4 4 0 0 0 .6-7.9A6 6 0 0 0 6 8.6 4.6 4.6 0 0 0 7 18z"></path><path d="M13 11l-2.2 3h2l-1.2 3 3.2-4h-2L13 11z"></path>',
  repeat:'<path d="M17 7H7a4 4 0 0 0-4 4"></path><path d="M14 4l3 3-3 3"></path><path d="M7 17h10a4 4 0 0 0 4-4"></path><path d="M10 20l-3-3 3-3"></path>',
  ...
  scan:'<path d="M4 9V5a1 1 0 0 1 1-1h4M15 4h4a1 1 0 0 1 1 1v4M20 15v4a1 1 0 0 1-1 1h-4M9 20H5a1 1 0 0 1-1-1v-4"></path><rect x="8" y="8" width="3" height="3" rx=".5"></rect><rect x="13" y="13" width="3" height="3" rx=".5"></rect>',
  copy:'<rect x="8" y="8" width="11" height="11" rx="2.5"></rect><path d="M16 8V5.5A2.5 2.5 0 0 0 13.5 3h-8A2.5 2.5 0 0 0 3 5.5v8A2.5 2.5 0 0 0 5.5 16H8"></path>',
  check:'<path d="M5 12.5l4.1 4.1L19 6.8"></path>',refresh:'<path d="M20 6v5h-5"></path><path d="M18.4 9A7 7 0 1 0 19 14"></path>',doorout:'<path d="M10 4H5v16h5"></path><path d="M14 8l4 4-4 4M9 12h9"></path>',undo:'<path d="M7 7H3v-4"></path><path d="M3.5 7.5A8 8 0 1 1 4 17"></path>',info:'<circle cx="12" cy="12" r="9"></circle><path d="M12 11v6"></path><circle cx="12" cy="7.5" r=".8" fill="currentColor" stroke="none"></circle>',trash:'<path d="M4 7h16"></path><path d="M9 7V4h6v3"></path><path d="M7 7l1 13h8l1-13"></path><path d="M10 11v5M14 11v5"></path>',branch:'<circle cx="6" cy="5" r="2"></circle><circle cx="18" cy="7" r="2"></circle><circle cx="6" cy="19" r="2"></circle><path d="M6 7v10M8 8h4a4 4 0 0 1 4 4v3"></path>',search:'<circle cx="10.5" cy="10.5" r="6.5"></circle><path d="M15.5 15.5L21 21"></path>',shield:'<path d="M12 3l7 3v5c0 5-3 8-7 10-4-2-7-5-7-10V6l7-3z"></path><path d="M9.4 12.2l1.8 1.8 3.8-4"></path>',xmark:'<path d="M7 7l10 10M17 7L7 17"></path>',help:'<circle cx="12" cy="12" r="9"></circle><path d="M9.7 9a2.4 2.4 0 1 1 3.7 2c-1 .7-1.4 1.1-1.4 2.3"></path><circle cx="12" cy="17" r=".8" fill="currentColor" stroke="none"></circle>',chevronleft:'<path d="M15 18l-6-6 6-6"></path>',chevronright:'<path d="M9 18l6-6-6-6"></path>'
});
function __CFServerStripEmoji(value) { return String(value || '').replace(/[\p{Extended_Pictographic}\p{Regional_Indicator}\p{Emoji_Modifier}\uFE0F\u200D\u20E3\u{E0020}-\u{E007E}]/gu, ''); }
function __CFServerPlainText(value) { return __CFServerStripEmoji(String(value || '').replace(/<[^>]*>/g, ' ')).replace(/&nbsp;/gi, ' ').replace(/&[a-z0-9#]+;/gi, ' ').replace(/\s+/g, ' ').trim(); }
function __CFServerIconName(text) { const t=String(text||'').toLowerCase(); if(/全球|海外|国外|国家|地理|位置|location/.test(t))return'globe';if(/当前网络|网络信息|墙外|国内测试|网络/.test(t))return'wifi';if(/节点链接|复制节点|link/.test(t))return t.includes('复制')?'copy':'link2';if(/优选|开始优选/.test(t))return'sparkles';if(/小白|简单/.test(t))return'wand';if(/详细|配置|参数|设置|模板/.test(t))return'sliders';if(/ech|encrypted|加密/.test(t))return'keyhole';if(/cloudflare|cdn|proxyip/.test(t))return'cloudbolt';if(/订阅转换/.test(t))return'repeat';if(/刷新|更新/.test(t))return'refresh';if(/重置/.test(t))return'undo';if(/消息|通知|telegram/.test(t))return'bell';if(/日志|清单|列表/.test(t))return'list';if(/二维码/.test(t))return'scan';if(/复制/.test(t))return'copy';if(/保存|确定|应用/.test(t))return'check';if(/退出/.test(t))return'doorout';if(/清除|删除/.test(t))return'trash';if(/提示|说明|为什么/.test(t))return'info';if(/链式|路由/.test(t))return'branch';if(/获取更多|搜索|验证/.test(t))return'search';if(/socks|安全|证书/.test(t))return'shield';if(/^[‹<\u25C0←]/.test(t))return'chevronleft';if(/^[›>\u25B6→]/.test(t))return'chevronright';if(/关闭|取消/.test(t))return'xmark';return'help'; }
function __CFServerSvgIcon(name) { const body=__CF_SERVER_ICON_PATHS[name]||__CF_SERVER_ICON_PATHS.help; return `<span class="cfnew-icon cfnew-inline-icon" aria-hidden="true"><svg viewBox="0 0 24 24">${body}</svg></span>`; }
function __CFServerIconizeHtml(html) {
  const tagRe=/<(button|h1|h2|h3|h4)(\b[^>]*)>([\s\S]*?)<\/\1>/gi;
  html=html.replace(tagRe,(all,tag,attrs,inner)=>{const text=__CFServerPlainText(inner);if(!text)return all;const special=/^[‹›<>\u25C0\u25B6←→⌃⌄]$/.test(text);const hadEmoji=/[\p{Extended_Pictographic}\p{Regional_Indicator}\p{Emoji_Modifier}\uFE0F\u200D\u20E3\u{E0020}-\u{E007E}]/u.test(inner);const should=tag.toLowerCase()!=='button'||hadEmoji||special||/二维码|复制|保存|退出|重置|参数配置|清除配置|路径模板|获取更多|为什么|开始优选|订阅接口|链式代理|我是小白/.test(text);if(!should)return all;const clean=__CFServerStripEmoji(inner);return `<${tag}${attrs}>${__CFServerSvgIcon(__CFServerIconName(text))}${special?'':clean}</${tag}>`;});
  const titleRe=/<(div|span)(\b[^>]*class=["'][^"']*(?:module-title|section-title|card-title|network-card-title)[^"']*["'][^>]*)>([\s\S]*?)<\/\1>/gi;
  html=html.replace(titleRe,(all,tag,attrs,inner)=>{const text=__CFServerPlainText(inner);if(!text)return all;return `<${tag}${attrs}>${__CFServerSvgIcon(__CFServerIconName(text))}${__CFServerStripEmoji(inner)}</${tag}>`;});
  return html;
}
function __CFServerNormalizeHtml(html) { return String(html || ''); }

// IMPORTANT: do not rewrite/minify upstream HTML before its own scripts execute.
function __CFStyleRemoteHtml(html, kind = 'admin', modules = '') {
  if (typeof html !== 'string' || !/<html[\s>]/i.test(html) || html.includes('data-cfnew-ui=')) return html;
  const pageKind = kind === 'admin' ? 'admin' : 'simple';
  const moduleValue = __CFNormalizeModules(modules);
  // Preserve upstream HTML/inline JavaScript byte-for-byte. UI cleanup happens after DOMContentLoaded.
  html = __CFServerNormalizeHtml(html);
  html = html.replace(/<html([^>]*)>/i, `<html$1 data-cfnew-ui="${__CF_UI_VERSION}" data-cfnew-page="${pageKind}" data-cfnew-modules="${moduleValue}">`);
  html = html.replace(/<head([^>]*)>/i, `<head$1>${__CF_UI_EARLY}`);
  if (/<\/head>/i.test(html)) html = html.replace(/<\/head>/i, `${__CF_UI_CSS}</head>`); else html = __CF_UI_CSS + html;
  html = html.replace(/<title>[^<]*<\/title>/i, `<title>${pageKind === 'admin' ? 'CFnew · 设置中心' : 'CFnew'}</title>`);
  if (/<\/body>/i.test(html)) html = html.replace(/<\/body>/i, `${__CF_UI_RUNTIME}</body>`);
  else html += __CF_UI_RUNTIME;
  return html;
}
async function __CFGetStyledStaticPage(path, options = {}) {
  const response = await fetch(Pages静态页面 + path, { headers: { 'Cache-Control': 'no-cache', Pragma: 'no-cache' } });
  const headers = new Headers(response.headers);
  headers.delete('content-length'); headers.delete('content-encoding'); headers.delete('etag');
  headers.set('Cache-Control', 'no-store, no-cache, must-revalidate, proxy-revalidate'); headers.set('Pragma', 'no-cache'); headers.set('Expires', '0');
  const type = headers.get('content-type') || '';
  if (!/text\/html/i.test(type)) return new Response(response.body, { status: options.status || response.status, statusText: response.statusText, headers });
...
<div class="topbar">
  <div class="brand"><span class="brand-mark"><svg class="icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3l8 4.5-8 4.5-8-4.5L12 3z"></path><path d="M4 12l8 4.5 8-4.5M4 16.5l8 4.5 8-4.5"></path></svg></span><span>CFnew</span></div>
...
<main class="login-shell">
  <section class="login-card" aria-labelledby="loginTitle">
    <div class="hero-icon"><svg class="icon" viewBox="0 0 24 24" aria-hidden="true"><rect x="5" y="8.5" width="14" height="11.5" rx="3"></rect><path d="M8.5 8.5V6.7a3.5 3.5 0 0 1 7 0v1.8"></path><circle cx="12" cy="14" r="1.4"></circle><path d="M12 15.4v1.8"></path></svg></div>
...
export default {
	async fetch(request, env, ctx) {
		...
		const 管理员密码 = env.ADMIN || env.admin || env.PASSWORD || env.password || env.pswd || env.TOKEN || env.KEY || env.UUID || env.uuid || env.u || env.U;
		const 加密秘钥 = env.KEY || '勿动此默认密钥，有需求请自行通过添加变量KEY进行修改';
		const userIDMD5 = await MD5MD5(管理员密码 + 加密秘钥);
		const uuidRegex = /^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/;
		const envUUID = env.UUID || env.uuid || env.u || env.U;
		...
		if (访问路径 === 'version') {// 版本信息接口
			...
			if (!管理员密码) return __CFGetStyledStaticPage('/noADMIN', { status: 404 });
			// CFnew v1.5: direct visits to the deployment root always enter the login flow.
			if (url.pathname === '/' || url.pathname === '') return new Response('重定向中...', { status: 302, headers: { 'Location': '/login', 'Cache-Control': 'no-store' } });
			if ((env.KV || env.C || env.c) && typeof (env.KV || env.C || env.c).get === 'function') {
				...
				if (区分大小写访问路径 === 加密秘钥 && 加密秘钥 !== '勿动此默认密钥，有需求请自行通过添加变量KEY进行修改') {//快速订阅
					...
					if (访问路径 === 'admin/log.json') {// 读取日志内容
						const 读取日志内容 = await (env.KV || env.C || env.c).get('log.json') || '[]';
					...
					if (访问路径 === 'admin/init') {// 重置配置为默认值
						...
						if (访问路径 === 'admin/config.json') { // 保存config.json配置
							try {
								...
								// 保存到 KV
								await (env.KV || env.C || env.c).put('config.json', JSON.stringify(newConfig, null, 2));
							...
							try {
								...
								// 保存到 KV
								await (env.KV || env.C || env.c).put('cf.json', JSON.stringify(CF_JSON, null, 2));
								ctx.waitUntil(请求日志记录(env, request, 访问IP, 'Save_Config', config_JSON));
								return new Response(JSON.stringify({ success: true, message: '配置已保存' }), { status: 200, headers: { 'Content-Type': 'application/json;charset=utf-8' } });
							} catch (error) {
								console.error('保存配置失败:', error);
							...
							try {
								...
								if (newConfig.init && newConfig.init === true) {
									...
									await (env.KV || env.C || env.c).put('tg.json', JSON.stringify(TG_JSON, null, 2));
								} else {
									...
									await (env.KV || env.C || env.c).put('tg.json', JSON.stringify(newConfig, null, 2));
								}
								ctx.waitUntil(请求日志记录(env, request, 访问IP, 'Save_Config', config_JSON));
								return new Response(JSON.stringify({ success: true, message: '配置已保存' }), { status: 200, headers: { 'Content-Type': 'application/json;charset=utf-8' } });
							} catch (error) {
							...
							try {
								...
								await (env.KV || env.C || env.c).put('ADD.txt', customIPs);// 保存到 KV
						...
						let 本地优选IP = await (env.KV || env.C || env.c).get('ADD.txt') || 'null';
					...
					return __CFGetStyledStaticPage('/admin' + url.search, { modules: env.CFNEW_UI_MODULES || env.cfnew_ui_modules || __CF_BUNDLED_UI_MODULES });
					...
					if (用户客户端请求订阅 || 订阅转换后端请求订阅 || 作为优选订阅生成器) {
						...
						if (订阅类型 === 'mixed') {
							...
							if (!url.searchParams.has('sub') && config_JSON.优选订阅生成.local) { // 本地生成订阅
								...
								)[0] : await (env.KV || env.C || env.c).get('ADD.txt') ? await 整理成数组(await (env.KV || env.C || env.c).get('ADD.txt')) : (
									await 生成随机IP(request, config_JSON.优选订阅生成.本地IP库.随机数量, config_JSON.优选订阅生成.本地IP库.指定端口)
								)[0];
			...
			} else if (!envUUID) return __CFGetStyledStaticPage('/noKV', { status: 404 });
		}
...
async function 请求日志记录(env, request, 访问IP, 请求类型 = "Get_SUB", config_JSON, 是否写入KV日志 = true) {
	try {
		...
		if (config_JSON.TG.启用) {
			try {
				const TG_TXT = await (env.KV || env.C || env.c).get('tg.json');
		...
		if (!是否写入KV日志) return;
		let 日志数组 = [];
		const 现有日志 = await (env.KV || env.C || env.c).get('log.json'), KV容量限制 = 4;//MB
		if (现有日志) {
			try {
		...
		await (env.KV || env.C || env.c).put('log.json', JSON.stringify(日志数组, null, 2));
...
async function 读取config_JSON(env, hostname, userID, UA = "Mozilla/5.0", 重置配置 = false) {
	...
	try {
		let configJSON = await (env.KV || env.C || env.c).get('config.json');
		if (!configJSON || 重置配置 == true) {
			await (env.KV || env.C || env.c).put('config.json', JSON.stringify(默认配置JSON, null, 2));
	...
	try {
		const TG_TXT = await (env.KV || env.C || env.c).get('tg.json');
		if (!TG_TXT) {
			await (env.KV || env.C || env.c).put('tg.json', JSON.stringify(初始化TG_JSON, null, 2));
		} else {
			const TG_JSON = JSON.parse(TG_TXT);
	...
	try {
		const CF_TXT = await (env.KV || env.C || env.c).get('cf.json');
		if (!CF_TXT) {
			await (env.KV || env.C || env.c).put('cf.json', JSON.stringify(初始化CF_JSON, null, 2));
		} else {
