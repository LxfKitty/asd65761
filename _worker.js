...
// ===== CFnew UI layer v1.4.0: upstream 2026-08-11 core snapshot + iOS glass UI, Lucide-style vector icons, cool-tone controls, robust scrolling, passive-notice suppression =====
const __CF_UI_VERSION = 'cfnew-ios-glass-edt-v1.4.0';
...
/* CFnew v1.4: remove upstream amber/yellow palette and use a single cool glass interaction language. */
...
function stripAllEmoji(){var w=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT);var n;while(n=w.nextNode()){if(n.parentElement&&n.parentElement.closest('script,style,textarea,pre,code'))continue;var v=n.nodeValue||'';var x=v.replace(emojiRegex(),'');if(x!==v)n.nodeValue=x}}
...
function __CFServerStripEmoji(value) { return String(value || '').replace(/[\p{Extended_Pictographic}\uFE0F\u200D]/gu, ''); }
