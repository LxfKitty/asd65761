...
// ===== CFnew UI layer v1.1.1-r2: upstream core untouched; iOS glass presentation + unified icons + scroll fix =====
const __CF_UI_VERSION = 'cfnew-ios-glass-edt-v1.1.1-r2';
...
html[data-cfnew-theme="dark"]{--cf-bg:#0d1520;--cf-bg2:#121d2b;--cf-panel:rgba(27,39,54,.60);--cf-panel-strong:rgba(31,44,59,.78);--cf-control:rgba(43,57,73,.68);--cf-text:#edf3fb;--cf-muted:#aab6c5;--cf-faint:#7f8da0;--cf-border:rgba(255,255,255,.09);--cf-hairline:rgba(233,241,252,.11);--cf-accent:#83a1ff;--cf-accent2:#9aabff;--cf-accent-soft:rgba(131,161,255,.14);--cf-success:#72c7a0;--cf-danger:#ea8896;--cf-shadow:0 28px 82px rgba(0,0,0,.32),0 3px 14px rgba(0,0,0,.22)}
html{height:auto!important;min-height:100%!important;max-height:none!important;overflow-x:hidden!important;overflow-y:scroll!important;scrollbar-gutter:stable;scroll-behavior:smooth;overscroll-behavior-y:auto!important}body{height:auto!important;min-height:100vh!important;min-height:100dvh!important;max-height:none!important;overflow-x:hidden!important;overflow-y:visible!important;position:relative!important;inset:auto!important;touch-action:pan-y!important;overscroll-behavior-y:auto!important;font-family:-apple-system,BlinkMacSystemFont,"SF Pro Display","SF Pro Text","Segoe UI","PingFang SC","Microsoft YaHei",Arial,sans-serif!important;background:radial-gradient(circle at 12% 8%,rgba(117,151,235,.20),transparent 33%),radial-gradient(circle at 88% 86%,rgba(144,119,218,.13),transparent 36%),linear-gradient(145deg,var(--cf-bg),var(--cf-bg2))!important;color:var(--cf-text)!important;text-shadow:none!important;-webkit-font-smoothing:antialiased!important}#app,#root,.app,.app-shell,.app-container,.main-container,.page-container,main{height:auto!important;min-height:0!important;max-height:none!important;overflow:visible!important}.page-wrapper{position:relative!important;inset:auto!important}
body:before,body:after{animation:none!important}.page-wrapper{width:100%!important;max-width:none!important;height:auto!important;min-height:100vh!important;max-height:none!important;padding:58px 18px 92px!important;box-sizing:border-box!important;overflow:visible!important;display:flex!important;align-items:flex-start!important;justify-content:center!important}.card-container{width:min(100%,1120px)!important;max-width:1120px!important;height:auto!important;max-height:none!important;margin:0 auto!important;padding:24px!important;border:1px solid var(--cf-border)!important;border-radius:var(--cf-radius-xl)!important;background:linear-gradient(145deg,var(--cf-panel-strong),var(--cf-panel))!important;box-shadow:var(--cf-shadow)!important;backdrop-filter:blur(30px) saturate(145%)!important;-webkit-backdrop-filter:blur(30px) saturate(145%)!important;color:var(--cf-text)!important;overflow:visible!important}.card-container:before,.card-container:after{display:none!important;content:none!important}
.header,.page-header{padding:6px 2px 18px!important;margin:0 0 16px!important;border:0!important;border-top:0!important;border-bottom:1px solid var(--cf-hairline)!important;background:transparent!important;box-shadow:none!important}.header:before,.header:after,.page-header:before,.page-header:after,.header-title:before,.header-title:after{display:none!important;content:none!important;border:0!important;background:none!important}.header h1,.header-title h1,#pageTitle,.page-title{margin:0!important;color:var(--cf-text)!important;background:none!important;-webkit-text-fill-color:currentColor!important;text-shadow:none!important;font-weight:760!important;letter-spacing:-.028em!important}.header p,.header-subtitle,.page-subtitle,.subtitle{color:var(--cf-muted)!important;text-shadow:none!important}.page-icon{border-radius:17px!important;background:linear-gradient(145deg,var(--cf-accent),var(--cf-accent2))!important;box-shadow:0 12px 28px rgba(79,124,255,.22)!important;color:#fff!important}
.module,.network-card,.latency-card,.cf-stats-card,.cf-info-box,.status-card,.config-card{border:1px solid var(--cf-border)!important;border-radius:var(--cf-radius-lg)!important;background:linear-gradient(150deg,var(--cf-panel-strong),var(--cf-panel))!important;box-shadow:0 10px 32px rgba(41,58,82,.07)!important;color:var(--cf-text)!important;backdrop-filter:blur(24px) saturate(135%)!important;-webkit-backdrop-filter:blur(24px) saturate(135%)!important}.module{margin:0 0 14px!important;padding:20px!important;overflow:visible!important}.module:hover,.network-card:hover,.latency-card:hover{border-color:rgba(118,143,177,.24)!important;transform:none!important}.module-title,.network-card-title,.card-title,.section-title{display:flex!important;align-items:center!important;gap:9px!important;color:var(--cf-text)!important;border-color:var(--cf-hairline)!important;text-shadow:none!important;font-weight:730!important}.module-title:before,.module-title:after{box-shadow:none!important}.form-group label,.form-label,label{color:var(--cf-text)!important;text-shadow:none!important}.hint,.description,.form-hint,.help-text,small,.footer-hint{color:var(--cf-muted)!important}
input,select,textarea,.input-wrapper input,.input-wrapper select,.input-wrapper textarea{box-sizing:border-box!important;background:var(--cf-control)!important;color:var(--cf-text)!important;border:1px solid var(--cf-hairline)!important;border-radius:13px!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.28)!important;text-shadow:none!important;outline:none!important;transition:border-color .2s,box-shadow .2s,background .2s!important}input:focus,select:focus,textarea:focus{border-color:var(--cf-accent)!important;box-shadow:0 0 0 4px var(--cf-accent-soft)!important}input::placeholder,textarea::placeholder{color:var(--cf-faint)!important}select option{background:var(--cf-panel-strong)!important;color:var(--cf-text)!important}.input-wrapper:before,.input-wrapper:after{display:none!important}
button,.btn,.button{font-family:inherit!important;text-shadow:none!important;box-shadow:none!important;clip-path:none!important}.btn,button[class*="btn"],.button,button{border-radius:12px!important;transition:transform .16s,border-color .2s,background .2s!important}.btn,button[class*="btn"],.button{border:1px solid var(--cf-hairline)!important;background:var(--cf-control)!important;color:var(--cf-text)!important}.btn:hover,button[class*="btn"]:hover,.button:hover{transform:translateY(-1px)!important}.btn-primary,.primary-btn,.save-btn,.login-btn,.btn-success{background:linear-gradient(135deg,var(--cf-accent),var(--cf-accent2))!important;border-color:transparent!important;color:#fff!important;box-shadow:0 9px 22px rgba(79,124,255,.19)!important}.btn-danger,.danger-btn{background:rgba(208,92,109,.10)!important;border-color:rgba(208,92,109,.18)!important;color:var(--cf-danger)!important}.btn-secondary,.secondary-btn{background:var(--cf-control)!important;color:var(--cf-text)!important}.status-success,.success,.online{color:var(--cf-success)!important}.status-error,.error,.danger,.offline{color:var(--cf-danger)!important}.badge,.tag,.status-badge{border-color:var(--cf-hairline)!important;background:var(--cf-accent-soft)!important;color:var(--cf-accent)!important;box-shadow:none!important}
...
@media(max-width:760px){.page-wrapper{padding:62px 9px 92px!important}.card-container{padding:14px!important;border-radius:20px!important}.module{padding:15px!important;border-radius:17px!important}.cfnew-brand{left:9px;top:9px}.cfnew-theme-switcher{right:9px;top:9px}.cfnew-theme-switcher span{display:none}.cfnew-theme-switcher button{padding:6px 7px!important;font-size:11px!important}.header-buttons{flex-wrap:wrap!important}.cfnew-float-actions{right:10px;bottom:10px}.cfnew-float-actions button{width:42px;height:42px}.cfnew-float-actions button[data-action="save"]{min-width:82px;padding:0 13px!important}input,select,textarea{font-size:16px!important}}
...
var icons={
network:'<circle cx="6" cy="7" r="2.25"></circle><circle cx="18" cy="7" r="2.25"></circle><circle cx="12" cy="18" r="2.25"></circle><path d="M7.9 8.3l2.7 6.8M16.1 8.3l-2.7 6.8M8.3 7h7.4"></path>',
link:'<path d="M9.6 14.4l4.8-4.8"></path><path d="M7.2 16.8l-1.3 1.3a3.6 3.6 0 0 1-5.1-5.1l3.1-3.1A3.6 3.6 0 0 1 9 9.9"></path><path d="M16.8 7.2l1.3-1.3a3.6 3.6 0 0 1 5.1 5.1l-3.1 3.1a3.6 3.6 0 0 1-5.1 0"></path>',
gauge:'<path d="M4.3 17.5a8.5 8.5 0 1 1 15.4 0"></path><path d="M12 12l4.2-3.2"></path><circle cx="12" cy="12" r="1.45"></circle>',
sliders:'<path d="M4 6h7M15 6h5M4 12h3M11 12h9M4 18h10M18 18h2"></path><circle cx="13" cy="6" r="2"></circle><circle cx="9" cy="12" r="2"></circle><circle cx="16" cy="18" r="2"></circle>',
shieldlock:'<path d="M12 3l7 3v5.2c0 4.6-2.8 7.7-7 9.8-4.2-2.1-7-5.2-7-9.8V6l7-3z"></path><rect x="9" y="10.5" width="6" height="5" rx="1.5"></rect><path d="M10.5 10.5V9a1.5 1.5 0 0 1 3 0v1.5"></path>',
cloud:'<path d="M7.2 18h9.6a4.2 4.2 0 0 0 .5-8.4A5.8 5.8 0 0 0 6.1 8.1 4.6 4.6 0 0 0 7.2 18z"></path><path d="M9 13.5h6"></path>',
sync:'<path d="M19.5 8.3A8 8 0 0 0 6.4 5.6L4.5 7.5"></path><path d="M4.5 3.8v3.7h3.7"></path><path d="M4.5 15.7a8 8 0 0 0 13.1 2.7l1.9-1.9"></path><path d="M19.5 20.2v-3.7h-3.7"></path>',
bell:'<path d="M6.5 9.5a5.5 5.5 0 0 1 11 0c0 4.8 2 5.7 2 7.2h-15c0-1.5 2-2.4 2-7.2z"></path><path d="M10 20h4"></path>',
document:'<path d="M7 3h7l4 4v14H7z"></path><path d="M14 3v5h4M10 12h5M10 16h5"></path>',
qr:'<rect x="3.5" y="3.5" width="6" height="6" rx="1"></rect><rect x="14.5" y="3.5" width="6" height="6" rx="1"></rect><rect x="3.5" y="14.5" width="6" height="6" rx="1"></rect><path d="M14.5 14.5h2v2h-2zM18.5 14.5h2v6h-6v-2M14.5 18.5h2"></path>',
copy:'<rect x="8" y="8" width="11.5" height="11.5" rx="2.2"></rect><path d="M16 8V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2"></path>',
save:'<path d="M5 4h11l3 3v13H5z"></path><path d="M8 4v5h7V4M8 20v-6h8v6"></path>',
logout:'<path d="M10 5H5v14h5"></path><path d="M14 8.5l3.5 3.5-3.5 3.5M9.5 12h8"></path>',
reset:'<path d="M5.2 8.2A8 8 0 1 1 4.7 16"></path><path d="M5.2 4v4.2H9.4"></path>',
wand:'<path d="M4.5 19.5L15 9"></path><path d="M13.5 4.5l.8 2.2 2.2.8-2.2.8-.8 2.2-.8-2.2-2.2-.8 2.2-.8.8-2.2zM19 13l.6 1.5L21 15l-1.4.5L19 17l-.6-1.5L17 15l1.4-.5L19 13z"></path>',
question:'<circle cx="12" cy="12" r="9"></circle><path d="M9.8 9a2.4 2.4 0 1 1 3.2 2.3c-.8.3-1 1-1 1.7M12 17h.01"></path>',
route:'<circle cx="6" cy="18" r="2"></circle><circle cx="18" cy="6" r="2"></circle><path d="M8 18h3a3 3 0 0 0 3-3V9a3 3 0 0 1 3-3h1"></path>',
trash:'<path d="M5 7h14M9 7V4h6v3M7 7l1 13h8l1-13M10 10v7M14 10v7"></path>',
external:'<path d="M14 5h5v5M19 5l-8 8"></path><path d="M17 13v6H5V7h6"></path>',
download:'<path d="M12 4v10M8 10l4 4 4-4"></path><path d="M5 19h14"></path>',
key:'<circle cx="8.5" cy="12" r="3.5"></circle><path d="M12 12h8M17 12v3M14 12v2"></path>',
server:'<rect x="4" y="4" width="16" height="6" rx="2"></rect><rect x="4" y="14" width="16" height="6" rx="2"></rect><path d="M8 7h.01M8 17h.01M12 7h5M12 17h5"></path>',
edit:'<path d="M5 19l3.5-.7L18 8.8 15.2 6 5.7 15.5 5 19z"></path><path d="M13.8 7.4l2.8 2.8"></path>',
info:'<circle cx="12" cy="12" r="9"></circle><path d="M12 10.8v5.5M12 7.5h.01"></path>',
chevron:'<path d="M8 10l4 4 4-4"></path>',
brand:'<rect x="4" y="4" width="6" height="6" rx="1.7"></rect><rect x="14" y="4" width="6" height="6" rx="1.7"></rect><rect x="4" y="14" width="6" height="6" rx="1.7"></rect><path d="M14 17h6M17 14v6"></path>',
refresh:'<path d="M19.5 8.5A8 8 0 0 0 6.3 5.7L4.5 7.5"></path><path d="M4.5 4v3.5H8"></path><path d="M4.5 15.5a8 8 0 0 0 13.2 2.8l1.8-1.8"></path><path d="M19.5 20v-3.5H16"></path>'};
function icon(name,extra){return '<span class="cfnew-icon '+(extra||'')+'" aria-hidden="true"><svg viewBox="0 0 24 24">'+(icons[name]||icons.info)+'</svg></span>'}
function iconFor(text){var t=(text||'').toLowerCase();if(/小白|简单点|新手/.test(t))return'wand';if(/重置|恢复默认/.test(t))return'reset';if(/退出|登出/.test(t))return'logout';if(/当前网络|网络信息|地区|网络测试/.test(t))return'network';if(/节点链接|链式代理|链接/.test(t))return'link';if(/优选订阅|开始优选|随机优选|在线优选|本地优选/.test(t))return'gauge';if(/encrypted client hello|\bech\b|加密客户端|证书/.test(t))return'shieldlock';if(/cloudflare|cdn|proxyip/.test(t))return'cloud';if(/订阅转换|同步|刷新|更新/.test(t))return'sync';if(/消息|通知|telegram/.test(t))return'bell';if(/日志|清单|列表/.test(t))return'document';if(/详细配置|参数配置|设置|配置/.test(t))return'sliders';if(/二维码/.test(t))return'qr';if(/复制/.test(t))return'copy';if(/保存|应用/.test(t))return'save';if(/清除|删除/.test(t))return'trash';if(/为什么|帮助|什么是|提示/.test(t))return'question';if(/路径|路由/.test(t))return'route';if(/下载/.test(t))return'download';if(/github|前往|获取更多/.test(t))return'external';if(/uuid|token|密钥|密码/.test(t))return'key';if(/worker|pages|后端|服务器/.test(t))return'server';if(/编辑/.test(t))return'edit';if(/代理/.test(t))return'cloud';return'info'}
...
function addSemanticIcons(){var sel='.module-title,.section-title,.card-title,.network-card-title,h2,h3,button,a.btn,button[class*="btn"]';document.querySelectorAll(sel).forEach(function(el){if(el.dataset.cfnewIconDone&&el.querySelector(':scope > .cfnew-icon'))return;var raw=stripEmoji(el.textContent);if(!raw)return;var isSection=/module-title|section-title|card-title|network-card-title/.test(el.className||'')||/^H[23]$/.test(el.tagName);var should=isSection||/小白|简单点|二维码|复制|保存|退出|重置|参数配置|清除配置|路径模板|获取更多|为什么|什么是|开始优选|订阅接口|链式代理|下载|前往|刷新/.test(raw);if(!should)return;Array.prototype.slice.call(el.querySelectorAll(':scope > .cfnew-icon')).forEach(function(i){i.remove()});el.dataset.cfnewIconDone='1';el.insertAdjacentHTML('afterbegin',icon(iconFor(raw),'cfnew-inline-icon'))})}
...
function mountFloat(){if(document.documentElement.getAttribute('data-cfnew-page')!=='admin'||document.querySelector('.cfnew-float-actions'))return;var box=document.createElement('div');box.className='cfnew-float-actions';box.setAttribute('aria-label','页面快捷操作');var refresh=document.createElement('button');refresh.type='button';refresh.title='刷新页面';refresh.setAttribute('aria-label','刷新页面');refresh.innerHTML=icon('refresh');refresh.onclick=function(){location.reload()};var save=document.createElement('button');save.type='button';save.dataset.action='save';save.title='保存全部可见配置';save.innerHTML=icon('save')+'<span>保存</span>';save.onclick=saveAll;box.appendChild(refresh);box.appendChild(save);document.body.appendChild(box)}
function mountTheme(){if(document.getElementById('cfnewThemeSwitcher')){paint(get(),false);return}var brand=document.createElement('div');brand.className='cfnew-brand';brand.innerHTML='<span class="cfnew-brand-mark">'+icon('brand')+'</span><b>CFnew</b>';document.body.appendChild(brand);var box=document.createElement('div');box.id='cfnewThemeSwitcher';box.className='cfnew-theme-switcher';box.setAttribute('role','group');box.setAttribute('aria-label','主题模式');var cap=document.createElement('span');cap.textContent='主题';box.appendChild(cap);[['system','跟随系统'],['light','浅色'],['dark','深色']].forEach(function(x){var b=document.createElement('button');b.type='button';b.setAttribute('data-cfnew-mode',x[0]);b.textContent=x[1];b.onclick=function(){paint(x[0],true)};box.appendChild(b)});document.body.appendChild(box);paint(get(),false)}
function enhance(){if(RUN)return;RUN=true;try{retitle();modules();stripAllEmoji();addSemanticIcons();removeBottomActions();mountTheme();mountFloat();retitle()}finally{RUN=false}}
function watch(){if(observer)return;observer=new MutationObserver(function(){if(RUN)return;requestAnimationFrame(enhance)});observer.observe(document.body,{subtree:true,childList:true,characterData:true})}
function mount(){enhance();watch()}
...
function __CFStyleRemoteHtml(html, kind = 'admin', modules = '') {
  ...
  html = html.replace(/[\p{Extended_Pictographic}\p{Emoji_Presentation}\uFE0F\u200D\u20E3\u{1F1E6}-\u{1F1FF}]/gu, '');
...
async function __CFGetStyledStaticPage(path, options = {}) {
  ...
  headers.delete('content-length'); headers.delete('content-encoding'); headers.delete('etag'); headers.delete('content-security-policy'); headers.delete('content-security-policy-report-only');
